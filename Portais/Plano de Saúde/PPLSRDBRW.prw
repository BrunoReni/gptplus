...
if lAliB4Q
	...
	Else
		cSql3 += " SELECT B4Q_OPEMOV " + cSinSep + " B4Q_ANOAUT " + cSinSep + " B4Q_MESAUT " + cSinSep + " B4Q_NUMAUT GUIA, B4Q_NOMUSR BENEFICIARIO, B4Q_DATPRO DATA, B4Q_STATUS STATUS, B4Q_CANCEL CANCELADA, B4Q_STATUS STISS, "
	EndIf
...
if Len(aWhere) > 1 .And. aWhere[2][2] == "2" //Por beneficiario
	...
	cWhere2 += " AND BEA_OPEMOV " 	+ cSinSep  + " BEA_CODRDA IN (" + aWhere[3,2] + ") "
...
If Len(aWhere) > 1
	...
	If aWhere[2][2]=="1" //busca por guia
		...
		cWhere +=  " AND BEA_OPEMOV " + cSinSep + " BEA_CODRDA    IN (" + aWhere[3,2] + ") "
		cWhere1 += " AND BE4_CODOPE " + cSinSep + " BE4_CODRDA    IN (" + aWhere[3,2] + ") "
		cWhere4 += " AND BD5_OPEMOV " + cSinSep + " BD5_CODRDA    IN (" + aWhere[3,2] + ") "
		...
		If !Empty(asepara)
			...
			cWhere2 += "(SELECT  BE4_CODOPE " + cSinSep + " BE4_ANOINT " + cSinSep + " BE4_MESINT " + cSinSep + " BE4_NUMINT GUIA  FROM "  + RetSqlName("BE4") +  " WHERE  BE4_FILIAL = '" + xFilial('BE4') + "' " + 'AND ' + RetSqlName("BE4")+".D_E_L_E_T_ = ' ' " +  " AND BE4_CODOPE+BE4_CODRDA IN ("+ aWhere[3,2] +") "  
			...
			cWhere2 += "(SELECT  BEA_OPEMOV " + cSinSep + " BEA_ANOAUT " + cSinSep + " BEA_MESAUT " + cSinSep + " BEA_NUMAUT GUIA  FROM "  + RetSqlName("BEA") +  " WHERE  BEA_FILIAL = '" + xFilial('BEA') + "' " + ' AND ' + RetSqlName("BEA")+".D_E_L_E_T_ = ' '" +  "   AND BEA_OPERDA+BEA_CODRDA IN  ("+ aWhere[3,2] +") "
		...
		if lAliB4Q
			...
			cWhere3 += " AND B4Q_OPEMOV " + cSinSep + " B4Q_CODRDA    IN (" + aWhere[3,2] + ") "
		endIf
	...
	Else//busca por beneficiแrio
		...
		cWhere +=  " AND BEA_OPEMOV " + cSinSep + " BEA_CODRDA    IN (" + aWhere[3,2] + ") AND ( (BEA_OPEUSR = '" + asepara[1] + "' AND BEA_CODEMP = '" + asepara[2] + "' AND BEA_MATRIC = '" + asepara[3] + "' AND BEA_TIPREG = '" + asepara[4] + "' AND BEA_DIGITO = '" + asepara[5] + "') OR BEA_MATANT = '" + cNumGuiaMat + "' )"
		cWhere1 += " AND BE4_CODOPE " + cSinSep + " BE4_CODRDA    IN (" + aWhere[3,2] + ") AND ( (BE4_OPEUSR = '" + asepara[1] + "' AND BE4_CODEMP = '" + asepara[2] + "' AND BE4_MATRIC = '" + asepara[3] + "' AND BE4_TIPREG = '" + asepara[4] + "' AND BE4_DIGITO = '" + asepara[5] + "') OR BE4_MATANT = '" + cNumGuiaMat + "' )"
		...
		if lAliB4Q
			...
			cWhere3 += " AND B4Q_OPEMOV " + cSinSep + " B4Q_CODRDA    IN (" + aWhere[3,2] + ") "
		endIf
		cWhere4 +=  " AND BD5_OPEMOV " + cSinSep + " BD5_CODRDA    IN (" + aWhere[3,2] + ") AND ( (BD5_OPEUSR = '" + asepara[1] + "' AND BD5_CODEMP = '" + asepara[2] + "' AND BD5_MATRIC = '" + asepara[3] + "' AND BD5_TIPREG = '" + asepara[4] + "' AND BD5_DIGITO = '" + asepara[5] + "') OR BD5_MATANT = '" + cNumGuiaMat + "' )"
	EndIf
...
cSql += " GROUP BY BEA_OPEMOV " + cSinSep + " BEA_ANOAUT " + cSinSep + " BEA_MESAUT " + cSinSep + " BEA_NUMAUT, BEA_NOMUSR, BEA_DATPRO, BEA_STATUS, BEA_CANCEL, BEA_TIPGUI, BEA_LIBERA, BEA_NRLBOR, BEA_OPEMOV " + cSinSep + " BEA_CODEMP " + cSinSep + " BEA_MATRIC " + cSinSep + " BEA_TIPREG " + cSinSep + " BEA_DIGITO, BEA_CODRDA, BEA_CODLOC, BEA_STTISS, BEA_HORPRO, BEA_SENHA, " + RetSqlName(cAlias)+".R_E_C_N_O_ " + cGrpB53

cSql += " UNION " + cSql1 + cWhere1 
cSql += " GROUP BY BE4_CODOPE " + cSinSep + " BE4_ANOINT " + cSinSep + " BE4_MESINT " + cSinSep + " BE4_NUMINT, BE4_NOMUSR, BE4_PRVINT, BE4_STATUS, BE4_CANCEL, BE4_TIPGUI, BE4_CODOPE " + cSinSep + " BE4_CODEMP " + cSinSep + " BE4_MATRIC " + cSinSep + " BE4_TIPREG " + cSinSep + " BE4_DIGITO, BE4_CODRDA, BE4_CODLOC, BE4_STTISS, BE4_HORPRO, BE4_SENHA, " + RetSqlName(cAlias1)+".R_E_C_N_O_ " + cGrpB53

cSql += " UNION " + cSql2 + cWhere2
cSql += " GROUP BY B4A_OPEMOV " + cSinSep + " B4A_ANOAUT " + cSinSep + " B4A_MESAUT " + cSinSep + " B4A_NUMAUT, B4A_NOMUSR, B4A_DATSOL, B4A_STATUS, B4A_CANCEL, B4A_TIPGUI, B4A_GUIREF, B4A_OPEMOV " + cSinSep + " B4A_CODEMP" + cSinSep + " B4A_MATRIC " + cSinSep + " B4A_TIPREG " + cSinSep + " B4A_DIGITO, B4A_STTISS, B4A_SENHA, " + RetSqlName(cAlias2)+".R_E_C_N_O_ "  + cGrpB53

	if lAliB4Q
		cSql += " UNION " + cSql3 + cWhere3 
		
		If lFPosSTIS 
			cSql += " GROUP BY B4Q_OPEMOV " + cSinSep + " B4Q_ANOAUT " + cSinSep + " B4Q_MESAUT " + cSinSep + " B4Q_NUMAUT, B4Q_NOMUSR, B4Q_DATPRO, B4Q_STATUS, B4Q_CANCEL, B4Q_GUIREF, B4Q_OPEMOV " + cSinSep + " B4Q_CODEMP " + cSinSep + " B4Q_MATRIC " + cSinSep + " B4Q_TIPREG " + cSinSep + " B4Q_DIGITO, B4Q_STTISS, B4Q_SENHA, " + RetSqlName(cAlias3)+".R_E_C_N_O_ " + cGrpB53
		Else
			cSql += " GROUP BY B4Q_OPEMOV " + cSinSep + " B4Q_ANOAUT " + cSinSep + " B4Q_MESAUT " + cSinSep + " B4Q_NUMAUT, B4Q_NOMUSR, B4Q_DATPRO, B4Q_STATUS, B4Q_CANCEL, B4Q_GUIREF, B4Q_OPEMOV " + cSinSep + " B4Q_CODEMP " + cSinSep + " B4Q_MATRIC " + cSinSep + " B4Q_TIPREG " + cSinSep + " B4Q_DIGITO, B4Q_SENHA, " + RetSqlName(cAlias3)+".R_E_C_N_O_ " + cGrpB53
		EndIf 
	endIf
