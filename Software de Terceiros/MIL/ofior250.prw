...
While !((cAliasSF2)->(Eof()))
	...
	cQuery := "SELECT SD2.D2_GRUPO,SD2.D2_DOC,SD2.D2_SERIE,SD2.D2_NFORI,SD2.D2_SERIORI,SD2.D2_TES,SD2.D2_EMISSAO,SD2.D2_DESPESA,SD2.D2_VALFRE,SD2.D2_SEGURO,SD2.D2_VALISS,SD2.D2_TOTAL,SD2.D2_VALIPI,SD2.D2_CUSTO1 "
	cQuery += "FROM "
	cQuery += RetSqlName( "SD2" ) + " SD2 "
	cQuery += "WHERE "
	cQuery += "SD2.D2_FILIAL='"+ xFilial("SD2")+ "' AND SD2.D2_DOC = '"+(cAliasSF2)->(F2_DOC)+"' AND SD2.D2_SERIE = '"+(cAliasSF2)->(F2_SERIE)+"' AND "
...
While !((cAliasVEC)->(Eof()))
	...
	If MV_PAR08 # 1
		...
		Endif
		If SF4->F4_PISCRED == "2"     // Tributado
			If SF4->F4_PISCOF = "1" // Pis
				nContpis += SD2->D2_VALIMP6
			ElseIf SF4->F4_PISCOF = "2" // Cofins
				nContcof += SD2->D2_VALIMP5
			ElseIf SF4->F4_PISCOF = "3" // PIS/Cofins
				nContpis += SD2->D2_VALIMP6
				nContcof += SD2->D2_VALIMP5
			EndIf
		EndIf
