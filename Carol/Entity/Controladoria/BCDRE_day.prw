...
/*/
//-------------------------------------------------------------------
Method Setup( ) Class BCDRE_DAY
	_Super:Setup("DRE_Day", FACT, "CQ1")
Return
...
/*/
//-------------------------------------------------------------------
Method BuildView( ) Class BCDRE_DAY
	Local cView := ""
	...
	"INNER JOIN " + ;
		...
		"I13.I13_TIPO IN ('R', 'D', 'C') AND " + ;
		"I13.D_E_L_E_T_ = ' ' " + ;
	"WHERE " + ;
		"CQ1_DATA >= <<HISTORIC_PERIOD(5)>> "  + ;
		"AND CQ1.D_E_L_E_T_ = ' ' " + ;
		"<<TEST_QUERY>> "
