...
if lExsCmp
    cFiltro   := "@(B19_FILIAL = '" + xFilial("B19") + "') AND B19_PRINCI = '1'"
endif
...
if ( empty(oCab:getvalue("B19_FORNEC")) .or. empty(oCab:getvalue("DOC")) .or. empty(oCab:getvalue("SERIE")) .or. empty(oCab:getvalue("B19_LOJA")) )
    lRet := .f.
