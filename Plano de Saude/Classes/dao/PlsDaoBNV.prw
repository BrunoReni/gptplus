...
Method setExpired() Class PlsDaoBNV
    ...
    cQuery += "   ( BNV_STATUS IN (' ','0','1','2') AND BNV_QTDTRY < "+cQtdTry+" AND BNV_ROBOHR <= '" + cTimePost + "') OR " //Reseta para Post
	cQuery += "   ( BNV_STATUS IN ('3','4') AND BNV_QTDTRY < "+cQtdTry+" AND BNV_ROBOHR <= '" + cTimeGet  + "')) " //Reseta para Get
	cQuery += " AND D_E_L_E_T_ = ' ' "
