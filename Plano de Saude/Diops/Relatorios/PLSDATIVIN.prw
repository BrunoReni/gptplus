...
cQuery += " ON(CV3_TABORI = 'SE5' AND CV3_RECORI = CAST(SE5.R_E_C_N_O_ AS CHAR(17)) AND SE5.R_E_C_N_O_ = CV3_RECORI) "
...
While (cATINV)->(!EOF())
	...
	If lMigPls
	    aADD(aRet, {;
	        ...
	        TRANSFORM(Posicione("SA6", 1, xFilial("SA6")+SEH->(EH_BANCO+EH_AGENCIA+EH_CONTA), "A6_CGC"),"@R 99.999.999/9999-99"),;
	        cVincAns } )
