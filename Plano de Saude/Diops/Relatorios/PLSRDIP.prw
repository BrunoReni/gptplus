...
oReport:Say(75, 300, STR0001, oFnt14N)  //"DISTRIBUIÇÃO DOS SALDOS DE CONTAS A PAGAR"
...
oReport:Say(120, 250, STR0044, oFnt12N) //"Débitos de Operações com Planos de Saúde"

oReport:box(100, 580, 175 , 805)   
oReport:Say(112, 590, STR0045, oFnt12N) //"Outros Débitos Não Relacionados com"
oReport:Say(125, 650, STR0046, oFnt12N) //"Planos de Saúde"
...
oReport:Say(165, 248, STR0008, oFnt10c)  //"ação sobre"
oReport:Say(175, 248, STR0009, oFnt10c)  //"operações"	


oReport:box(130, 300, 200, 355) 
oReport:Say(155, 303, STR0010, oFnt10c)  //"Débitos"
...
oReport:Say(165, 358, STR0014, oFnt10c)  //"Débitos de"
oReport:Say(175, 358, STR0015, oFnt10c)  //"Operações"
...
oReport:Say(155, 468, STR0020, oFnt10c)  //"Depósitos de"
oReport:Say(165, 468, STR0021, oFnt10c)  //"Beneficiários -"
...
oReport:Say(175, 583, STR0028, oFnt10c)  //"Assistência"
oReport:Say(185, 583, STR0029, oFnt10c)  //"a Saúde"

oReport:box(130, 635, 200, 690) 
oReport:Say(155, 638, STR0030, oFnt10c)  //"Débitos com"
oReport:Say(165, 638, STR0031, oFnt10c)  //"Aquisição de"
oReport:Say(175, 638, STR0032, oFnt10c)  //"Carteira"

oReport:box(130, 690, 200, 745) 
oReport:Say(155, 693, STR0013, oFnt10c)  //"Outros"
oReport:Say(165, 693, STR0033, oFnt10c)  //"Débitos a"
...
nLinha := (136 + nSom - 5) //Diferença de 70 para 65
nSom := 0
nValor := 0
