...
cQuery += " B4E_SEQUEN, B4E_DATPRO, B4E_CODPAD, B4E_CODPRO, B4E_DESPRO, B4E_VLRREC, B4E_VLRACA, convert(char,B4E_JUSOPE) B4E_JUSOPE, convert(char,B4E_JUSPRE) B4E_JUSPRE, "
