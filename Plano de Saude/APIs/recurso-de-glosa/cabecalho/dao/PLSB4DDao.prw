...
cQuery += "   convert(char,B4D_JUSOPE) B4D_JUSOPE, convert(char,B4D_JUSGUI) B4D_JUSGUI, convert(char,B4D_JUSPRO) B4D_JUSPRO, "
cQuery += "   B4D_STATUS STATUS, "
...
if "ORACLE" $ upper(TCGetDb()) //Não remover por causa do STR
	cQuery += " B4D_OPEMOV||B4D_CODLDP||B4D_CODPEG||B4D_NUMAUT||B4D_QTDIRP CHAVE "
else
