...
Method New() Class PLSB4DMpr
    ...
    aAdd(self:aFields,{"B4D_JUSOPE","insurerJustification"})
    aAdd(self:aFields,{"B4D_JUSPRO","protocolJustification"})
    aAdd(self:aFields,{"B4D_JUSGUI","formNumberJustification"})
