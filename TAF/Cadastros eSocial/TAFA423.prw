...
Static Function ModelDef()
	...
	If TAFColumnPos("T2Q_CODLOT")
		oModel:SetRelation("MODEL_T2Q", {{"T2Q_FILIAL","xFilial('T2Q')"}, {"T2Q_ID","T2M_ID"}, {"T2Q_VERSAO","T2M_VERSAO"}, {"T2Q_ESTABE","T2P_ESTABE"}, {"T2Q_LOTACA","T2P_LOTACA"}, {"T2Q_CODLOT","T2P_CODLOT"}, {"T2Q_TPINSC","T2P_TPINSC"}, {"T2Q_NRINSC","T2P_NRINSC"}},T2Q->(IndexKey(1)) )
	Else
	...
	If TAFColumnPos("T2R_CODLOT")
		oModel:SetRelation("MODEL_T2R", {{"T2R_FILIAL","xFilial('T2R')"}, {"T2R_ID","T2M_ID"}, {"T2R_VERSAO","T2M_VERSAO"}, {"T2R_ESTABE","T2P_ESTABE"}, {"T2R_LOTACA","T2P_LOTACA"}, {"T2R_MATRIC","T2Q_MATRIC"},{"T2R_CODCAT","T2Q_CODCAT"},{"T2R_CODLOT","T2P_CODLOT"},{"T2R_TPINSC","T2P_TPINSC"},{"T2R_NRINSC","T2P_NRINSC"} },T2R->(IndexKey(1)) )
	Else
...
Function TAF423Grv(cLayout as character, nOpc as numeric, cFilEv as character, oXML as object, cOwner as character,;
	...
	cMotDes := GetMotDes(cAliEvtOri, nRecEvtOri)
...
@type			function
@description	Retorna o motivo de afastamento do evento que gerou o totalizador
...
/*/
//---------------------------------------------------------------------
Static Function GetMotDes(cAliEvtOri as character, nRecEvtOri as numeric)
