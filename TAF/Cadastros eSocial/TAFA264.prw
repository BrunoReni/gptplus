				...
				If CM9->CM9_STATUS == "4"
					...
					For nCMA := 1 To Len( aGravaCMA )
						...
						If Len(aGravaLEA) > 0 //Este modelo apesar de ser uma grid ̩ 0-1 no layout
							...
							oModel:LoadValue( "MODEL_LEA", "LEA_EFIEPC", aGravaLEA[1][3] )
							oModel:LoadValue( "MODEL_LEA", "LEA_UTZEPI", aGravaLEA[1][4] )
							oModel:LoadValue( "MODEL_LEA", "LEA_EFIEPI", aGravaLEA[1][5] )
							oModel:LoadValue( "MODEL_LEA", "LEA_MEDPRT", aGravaLEA[1][6] )
							oModel:LoadValue( "MODEL_LEA", "LEA_CNDFUN", aGravaLEA[1][7] )
							oModel:LoadValue( "MODEL_LEA", "LEA_PRZVLD", aGravaLEA[1][8] )		
							oModel:LoadValue( "MODEL_LEA", "LEA_PERTRC", aGravaLEA[1][9] )
							oModel:LoadValue( "MODEL_LEA", "LEA_HIGIEN", aGravaLEA[1][10])
							oModel:LoadValue( "MODEL_LEA", "LEA_USOINI", aGravaLEA[1][11])
