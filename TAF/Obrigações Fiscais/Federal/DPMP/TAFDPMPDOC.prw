...
Function TAFDPMPDOC(aWizard, nCont, aTotalizFn, aTotaliz)
	...
	BeginSql Alias cAlias1
		...
		INNER JOIN %table:C1L% C1L ON C1L.C1L_FILIAL = C30.C30_FILIAL  AND C1L.C1L_ID     = C30.C30_CODITE  AND C1L.%NotDel% //Join com o Cadastro de Itens
		INNER JOIN %table:C1N% C1N ON C1N.C1N_FILIAL = C30.C30_FILIAL  AND C1N.C1N_ID     = C30.C30_NATOPE	AND C1N.%NotDel% //Join com o Cadastro de Natureza de Operação
