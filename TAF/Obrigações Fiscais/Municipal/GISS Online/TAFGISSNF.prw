...
Function TAFSQLServ(cDtIniRef, cDtFimRef)
 ...
 cJoin += " INNER JOIN " + RetSqlName("C07") + " C07 ON C07.C07_FILIAL = '" + xFilial("C07") + "'"  
 cJoin += " AND C07.C07_ID = C1H.C1H_CODMUN AND C07.D_E_L_E_T_= ' ' "
 ...
 BeginSql Alias cAliasDoc
		...
		SELECT C20_FILIAL    DC_FILIAL,
	           ...
	           C09_UF		 PT_UF,
	           C07_DESCRI	 PT_MUNPIO,
	           C07_CODIGO    PT_CODMUN,
	           C08_SIGLA2	 PT_PAIS,
