...
default     cPerIni     :=  ''
default     lNotProtoc  := .t. // filtra APENAS os não protocolados
default     lAll        := .f.
default     nRegIni     := 0
default     nRegFim     := 0
default     lHasNext    := .F.
...
If cLayout $ "R-4010|R-4020|R-4040|R-4080|R-1050" .And. nRegIni > 0
	...
	ElseIf cLayout == 'R-4020'
		cSelectPage += " EVENTO , FILIAL, ID, STATUS, CNPJ, NOMEBEN, VLRTOT,BASEIR, VLRIR, VLCSLL, VCOFIN, VLRPP, RECNO FROM ( "
		...
		If PrepEnv( cEmpRequest, cFilRequest )
			...
			If Len( aEvents ) > 0
				...
				If self:event $ "R-1000|R-1070|R-2010|R-2020|R-2030|R-2040|R-2050|R-2055|R-2060|R-2099|R-2098|R-3010|R-9000|R-4010|R-4020|R-4040|R-4080|R-4099|R-1050" 
					If Len( aRegRec ) > 0
						aRetorno := TAFProc9TSS( .T., aEvents, Nil, Nil, Nil, Nil, Nil, @cMsgRet, Nil, Nil, Nil, Nil, Nil, aRegRec,, .T., @aRetErro )
