	...
	If !lTransf .And. lOk
									...
									If cEvento == "S-2200"
										...
										If T1U->( msSeek( xFilial("T1U", &(cAlias+"->"+cAlias+"_FILIAL")) + cIdTrab + '1' ) )
											While T1U->(!Eof()) .And. (cIdTrab + '1') == T1U->( T1U_ID + T1U_ATIVO )
												...
												//Caso o registro ja tenha sido transmitido eu gero o evento de exclusão S-3000 para S-2205
												If T1U->T1U_STATUS == '4'
													cEvento := "S-2205"
													...
													//Gero o evento de exclusão para o evento S-2205
													GerEventEx(cEvento, cIdEv, 'T1U', cDescEv, cCpf, cNis, nReg, nOper, cTpEvt, cProtUl, .F.)

												Else
													//Se não apaga o registro ativo da base
										...
										If T1V->( msSeek( xFilial("T1V", &(cAlias+"->"+cAlias+"_FILIAL")) + cIdTrab + '1' ) )
											While T1V->(!Eof()) .And. (cIdTrab + '1') == T1V->( T1V_ID + T1V_ATIVO )
												...
												//Caso o registro ja tenha sido transmitido eu gero o evento de exclusão S-3000 para S-2206
												If T1V->T1V_STATUS == '4'
													cEvento := "S-2206"
													...
													//Gero o evento de exclusão para o evento S-2206
									...
									ElseIF cEvento == "S-2300"
										...
										If T0F->( msSeek( xFilial("T0F", &(cAlias+"->"+cAlias+"_FILIAL")) + cIdTrab + '1' ) )
											While T0F->(!Eof()) .And. (cIdTrab + '1') == T0F->( T0F_ID + T0F_ATIVO )
												...
												//Caso o registro ja tenha sido transmitido eu gero o evento de exclusão S-3000 para S-2306
												If T0F->T0F_STATUS == '4'
													cEvento := "S-2306"
													...
													//Gero o evento de exclusão para o evento S-2306
		...
		ElseIf nOpc == 2 .Or.  nOpc == 3
			...
			Else
				...
				EndIf
			Else
				//****DESFAZER EXCLUSÃO E VISUALIZAR REGISTRO ECLUIDO PARA S-2501 E S-2500****//
				V7J->(dbSetOrder(2))
...
Gera TAFST2 à partir da integração via GPE.
