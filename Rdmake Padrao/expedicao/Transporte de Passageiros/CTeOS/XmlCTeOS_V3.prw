...
@return	XmlCTeOS_V3      XML do CTeOS
...
/*/
//----------------------------------------------------------
user function XmlCTeOS_V3(cTipo, cSerie, cNota,cCliFor, cLoja, cAmbiente, cVersao, cModalidade, cTimeZone, cModal, cEvento)
	local cChave     := ''
	Local CTeOSXML   := ''
	Local cDoc_Chv	 := ''
	Local cChvAnu	 := ''
