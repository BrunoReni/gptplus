...
ElseIf nPreco == 0
	MsgAlert(STR0024) //Produto cadastrado sem preço
	lRet := .F.
Endif

If !lRet .AND. Len(aCols) > 1 .AND. aCols[Len(aCols),_nPosUni] == 0 // Valida se o ultimo item do aCols foi negado, caso positivo ele é retirado
