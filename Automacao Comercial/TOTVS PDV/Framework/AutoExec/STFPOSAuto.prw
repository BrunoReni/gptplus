...
Static Function STFSaleAuto( aCab , aItens , aPgtos, aNCCsCli )
	...
	If lRet
		...
		For nI := 1 To Len(aItens)			
			...
			If lRet
				//Atualiza Cesta
				StaticCall(STBImportSale, STBISL2Refresh, aItens[nI] , nNextItem )		
...
If(StaticCall(STIIncCustomer,STICGCVld,aCliente[6][2],aCliente[4][2],@cCodCliente,oLojCliente,.T.,aCliente[1][2]),,(cErro := "CPF: "+aCliente[6][2]+", invalido!",lRet := .F.))
