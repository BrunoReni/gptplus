...
oBtnConfirm	:= TButton():New(	POSVERT_BTNFOCAL,;
							...
							STR0011,;    //"Confirmar"
							oMainPanel	,;
							{|| STIConfirmBleeding(1,cComboCx,nDinheiro, nCheque, nCDebito, nCCredito,nFinanciado,nConven,nVales,nOutros,aCaixas,nPD,nPIX)},;
							LARGBTN			,;
							ALTURABTN		,;
							,,,.T.,;
							,,,{|| !Empty(cComboCx)})

oBtnCancel := TButton():New(	POSVERT_BTNFOCAL,POSHOR_1,STR0020,oMainPanel,{ || IIf(STBOpenCash(),STIRegItemInterface(),STIExchangePanel( { || STIPanOpenCash() } )) }, ; //"Cancelar"
								LARGBTN,ALTURABTN,,,,.T.	)
...
oBtnConfirm	:= TButton():New(	POSVERT_BTNFOCAL,;
							...
							STR0011,;  //"Confirmar"
							oMainPanel	,;
							{|| STIConfirmBleeding(2,cComboCx,nDinheiro,,,,,,,,aCaixas)},;
							LARGBTN			,;
							ALTURABTN		,;
							,,,.T.,;
							,,,{|| !Empty(cComboCx)})
...
Static Function STIConfirmBleeding(nOpc,cCaixa,nDinheiro, nCheque, nCDebito, nCCredito,nFinanciado,nConven,nVales,nOutros,aCaixas,nPD,nPIX)
