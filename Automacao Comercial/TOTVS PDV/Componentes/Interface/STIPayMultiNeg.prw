...
If ExistFunc("STDVldMn")
	STDVldMn(@aItens) //Valido se exitem itens de Multi NegociaÁ„o
EndIf
...
@ nTop,nLeft SAY oSay PROMPT STR0026 SIZE oPnlRodape:nWidth/2-35,40 OF oPnlRodape PIXEL HTML //"Resumo"
oSay:SetCSS( POSCSS (GetClassName(oSay), CSS_BREADCUMB )) 

nTop += 16
@ nTop,nLeft SAY oSay PROMPT STR0006 SIZE oPnlRodape:nWidth/2-35,40 OF oPnlRodape PIXEL HTML //"Entrada"
oSay:SetCSS( POSCSS (GetClassName(oSay), CSS_LABEL_NORMAL )) 
oLblResEntr := TSay():New(nTop+012, nLeft, {||aResume[01]}, oPnlRodape,,,,,,.T.,,,nLargura-140,8)
oLblResEntr:SetCSS( POSCSS (GetClassName(oLblResEntr), CSS_LABEL_FOCAL )) 

nLeft += 65
@ nTop,nLeft SAY oSay PROMPT STR0027 SIZE oPnlRodape:nWidth/2-35,40 OF oPnlRodape PIXEL HTML //"Qtd.Parcelas"
oSay:SetCSS( POSCSS (GetClassName(oSay), CSS_LABEL_NORMAL )) 
oLblQtdParc := TSay():New(nTop+012, nLeft, {||aResume[02]}, oPnlRodape,,,,,,.T.,,,nLargura-140,8)
oLblQtdParc:SetCSS( POSCSS (GetClassName(oLblQtdParc), CSS_LABEL_FOCAL )) 

nLeft += 65
@ nTop,nLeft SAY oSay PROMPT STR0028 SIZE oPnlRodape:nWidth/2-35,40 OF oPnlRodape PIXEL HTML //"Venc. 1™ Parcela"
oSay:SetCSS( POSCSS (GetClassName(oSay), CSS_LABEL_NORMAL )) 
oLblVenParc := TSay():New(nTop+012, nLeft, {||aResume[03]}, oPnlRodape,,,,,,.T.,,,nLargura-140,8)
oLblVenParc:SetCSS( POSCSS (GetClassName(oLblVenParc), CSS_LABEL_FOCAL )) 

nLeft += 65
@ nTop,nLeft SAY oSay PROMPT STR0029 SIZE oPnlRodape:nWidth/2-35,40 OF oPnlRodape PIXEL HTML //"Valor Parcela"
oSay:SetCSS( POSCSS (GetClassName(oSay), CSS_LABEL_NORMAL)) 
oLblVlrParc := TSay():New(nTop+012, nLeft, {||aResume[04]}, oPnlRodape,,,,,,.T.,,,nLargura-140,8)
oLblVlrParc:SetCSS( POSCSS (GetClassName(oLblVlrParc), CSS_LABEL_FOCAL)) 

nLeft += 65
@ nTop,nLeft SAY oSay PROMPT STR0052 SIZE oPnlRodape:nWidth/2-35,40 OF oPnlRodape PIXEL HTML //"Val Ate Venc"
oSay:SetCSS( POSCSS (GetClassName(oSay), CSS_LABEL_NORMAL)) 
oLblAcresci := TSay():New(nTop+012, nLeft, {||aResume[05]}, oPnlRodape,,,,,,.T.,,,nLargura-140,8)
oLblAcresci:SetCSS( POSCSS (GetClassName(oLblAcresci), CSS_LABEL_FOCAL)) 

nLeft += 65
@ nTop,nLeft SAY oSay PROMPT STR0030 SIZE oPnlRodape:nWidth/2-35,40 OF oPnlRodape PIXEL HTML //"AcrÈscimo"
oSay:SetCSS( POSCSS (GetClassName(oSay), CSS_LABEL_NORMAL)) 
oLblAcresci := TSay():New(nTop+012, nLeft, {||aResume[10]}, oPnlRodape,,,,,,.T.,,,nLargura-140,8)
oLblAcresci:SetCSS( POSCSS (GetClassName(oLblAcresci), CSS_LABEL_FOCAL)) 

nLeft += 65
@ nTop,nLeft SAY oSay PROMPT STR0031 SIZE oPnlRodape:nWidth/2-35,40 OF oPnlRodape PIXEL HTML //"Valor Total"
oSay:SetCSS( POSCSS (GetClassName(oSay), CSS_LABEL_NORMAL)) 
oLblVlrTota := TSay():New(nTop+012, nLeft, {||aResume[06]}, oPnlRodape,,,,,,.T.,,,nLargura-140,8)
	...
	For nFor := 1 To LEN(aTpDownPay) + 1 // Processa todas as Entradas e por fim processa a Negociacao escolhida.
		...
		If lRet				
			...
			If lEntrada .AND. !EMPTY(aTpDownPay[nFor][01])	// Se for entrada e Tiver entrada no array aTpDownPay
				...
				If !AllTrim(aTpDownPay[nFor][02]) $ "CC/CD"
...
If lRet .AND. (!lMvLjIcmJ .Or. (lMvLjIcmJ .And. (Alltrim(aResume[07]) $ "CC/CD"))) .AND. nAcresc > 0 .AND. !lRecebTitle
	...
	STWAddIncrease(aAcresc[1], nAcresc)
