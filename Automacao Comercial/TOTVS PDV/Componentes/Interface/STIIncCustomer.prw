...
lRet := STDExistChav("SA1",cCodCliente+cLojCliente,,STR0003)  //"Já existe cliente cadastrado com o mesmo código e loja, favor alterar."
...
If !Empty(cCGC)   
	...
	While !lDisp .And. ntent <= nLimit 
		...
		If !lDisp .AND. ntent == nLimit 
			STFMessage(ProcName(),"STOP",STR0003) //"Já existe cliente cadastrado com o mesmo código e loja, favor alterar."
			STFShowMessage(ProcName())
		EndIf
