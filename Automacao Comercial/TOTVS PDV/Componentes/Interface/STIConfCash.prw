...
oBtnCancela	:= TButton():New(	POSVERT_BTNFOCAL,POSHOR_BTNFOCAL-90,STR0023,oMainPanel,{|| STICancelConference()}, ; //"Cancelar"
							LARGBTN,ALTURABTN,,,,.T.)							
oBtnCancela:SetCSS(POSCSS(GetClassName(oBtnCancela), CSS_BTN_FOCAL))

//Botao Confirmar Conferencia
oBtnConfirm	:= TButton():New(	POSVERT_BTNFOCAL,POSHOR_BTNFOCAL,STR0007,oMainPanel,{|| STIConfirmConference(lLeitX,lReduZ)}, ; //"Confirmar"
							LARGBTN,ALTURABTN,,,,.T.)
...
/*/
//-------------------------------------------------------------------
Static Function STIConfirmConference(lLeitX, lReduZ)
Local nX 			:= 0
Local cTexto		:= ''
...
/*/
//-------------------------------------------------------------------
Static Function STICancelConference()
