...
/*/
//-------------------------------------------------------------------
Function STDFinishSale(lEmiteNFe)
...
If STDGPBasket("SL1","L1_TIPO") == "P" .And. Empty(STDGPBasket("SL1","L1_PEDRES")) .And. !Empty(STDGPBasket("SL1","L1_ORCRES")) //Indica que eh importacao de orcamento filho com apenas itens de "Retira Posterior"
