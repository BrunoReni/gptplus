...
cTexto +=  SM0->M0_NOMECOM + CHR(10)+CHR(13) + CHR(10)+CHR(13)


If nOperacao == 1 //"SANGRIA"
	cTexto +=  TAG_CENTER_INI+TAG_NEGRITO_INI+STR0020 + " " + STR0044+TAG_NEGRITO_FIM+TAG_CENTER_FIM + CHR(10)+CHR(13) //"Saida de Caixa"###"(Acumulado)"
ElseIf nOperacao == 2 //"TROCO"
	cTexto += TAG_CENTER_INI+TAG_NEGRITO_INI+STR0037 + " " + STR0044+TAG_NEGRITO_FIM+TAG_CENTER_FIM + CHR(10)+CHR(13) //"Suprimento de Caixa"###"(Acumulado)"
EndIf
cTexto += "- - - - - - - - - - - - - - - - - - - - - -" + CHR(10)+CHR(13)

cTexto += STR0045	+ cTotal 		+ CHR(10)+CHR(13)					//"VALOR        : R$ "
cTexto += STR0046	+ DtoC(Date()) + " - " + Time()	+ CHR(10)+CHR(13)	//"DATA         : "
cTexto += STR0047 	+ aID[1][1]		+ CHR(10)+CHR(13)					//"CAIXA        : "
cTexto += STR0041	+ "      : "	+ aID[2][1] 	+ CHR(10)+CHR(13)	//"ESTACAO"
cTexto += STR0048	+ aID[4][1] 	+ CHR(10)+CHR(13)					//"PDV          : "
cTexto += STR0042 + "     : "	+ cNumMov 		+ CHR(10)+CHR(13)		//"NUM.MOV."
cTexto += "- - - - - - - - - - - - - - - - - - - - - -" + CHR(10)+CHR(13)
cTexto += STR0035 + " ________________________________" + Replic(CHR(10)+CHR(13),2) //"Ass. Caixa   :"
cTexto += STR0036 + " ________________________________" + Replic(CHR(10)+CHR(13),6) //"Ass. Superior:"
...
If lRet
	...
	EndIf
	cTexto += CRLF
	cTexto += PadR("DATA",13)+": " + DtoC(Date()) + CRLF
	cTexto += PadR(Iif(cOperacao=="TROCO", STR0039,STR0040),13)+": " + aID[1][1]  + "-" + GetAdvfVal("SA6","A6_NOME",xFilial("SA6") + RTrim(aID[1][1]),1) + CRLF //#"CX.DESTINO" ##"CX.ORIGEM"
	cTexto += PadR(Iif(cOperacao=="TROCO", STR0040,STR0039),13)+": " + aCxDest[1] + "-" + aCxDest[4] + CRLF //#"CX.ORIGEM" ##"CX.DESTINO"
	cTexto += PadR(STR0041,13) + ": " + aID[2][1] + CRLF	//#"ESTACAO"
	cTexto += PadR("PDV",13)+ ": " + aID[4][1] + CRLF
	cTexto += PadR(STR0042,13) + ": " + cNumMov + CRLF	//#"NUM.MOV."
	cTexto += cLinSep + CRLF
