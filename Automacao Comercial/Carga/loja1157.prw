			...
			oLJILResult := oLJMessenger:GetILResult()
				...
				If !oLJCMessageManager:HasError()	
					...
					If !oLJCMessageManager:HasError()
						...
						oSelectorLoad:MarkIncLoad() //seleciona automaticamente as cargas necessarias para deixar o ambiente atualizado conforme opcao de acao (importar ou apenas baixar)
