...
Function LjLayAuxCg()
    ...
    Else
        ...
        If oGithub:oGit:oResponseh:cStatuscode == "403"
            MsgAlert("Limite de solicitações excedido. Tente novamente dentro de 1 hora")//"Limite de solicitações excedido. Tente novamente dentro de 1 hora"
        Else
            MsgAlert("Falha na carga da lista dos arquivos de Layout")//"Falha na carga da lista dos arquivos de Layout"
        EndIf 
