...
Method LayEstAuto(cCmpRet, cModelo, cSerie, cEstacao, cCodLoja) Class RmiBusLiveObj
    ...
    If !Empty(cFilRmi)
        ...
        Do Case
            ...
            OTherWise
                ...
                self:cRetorno += I18n("Dados recebidos não conferem com as regras estabelecidas: SiglaModelo=[#1] SerieNFCe=[#2]", {cModelo, cSerie}) + CRLF
    ...
    Else
        ...
        self:lSucesso := .F.
        self:cTipoRet := "ESTACAO"
        self:cRetorno += I18n("Não foi realizado o De/Para da Filial: CodigoLoja=[#1]", {self:oRegistro:_CodigoLoja:Text} ) + CRLF
    EndIf
