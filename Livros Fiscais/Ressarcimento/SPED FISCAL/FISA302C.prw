...
Function FISA302CA(oSay,cPerApur)
	...
	cItem := xFilial("SFT") + (cAlias)->FT_NFISCAL + (cAlias)->FT_SERIE + (cAlias)->FT_TIPOMOV + (cAlias)->FT_PRODUTO
	...
	While !(cAlias)->(Eof())
		...
		(cAlias)->(dbSkip())
		cProxIt := xFilial("SFT") + (cAlias)->FT_NFISCAL + (cAlias)->FT_SERIE + (cAlias)->FT_TIPOMOV + (cAlias)->FT_PRODUTO
