...
FillGetDados(nOpcx,"SD1",1,cSeek,{|| &cWhile },/*uSeekFor*/,aNoFields,aGetCpo,/*lOnlyYes*/,/*cQuery*/,/*bMontCols*/,l910Inclui,/*aHeaderAux*/,/*aColsAux*/,/*bAfterCols*/,{|| IIF(l910Deleta .and. !SoftLock("SD1"),lContinua := .F.,.T.)},/*bAfterHeader*/,/*cAliasQry*/,/*bCriaVar*/,.T.,aYesUsado)
