...
Static Function fMakePag01(o_Dialog)
	...
	Local cTxtBtn  := "Novo! Conheça o TSI e agilize as suas entregas realizadas pelo módulo Automação Fiscal"
	Local oBtnNews := nil
	...
	oBtnNews := THButton():New( (o_Dialog:nClientHeight/2)-10, 25,cTxtBtn,o_Dialog,{||ShellExecute("open","https://tdn.totvs.com/x/QOYhIQ","","",1)},600,10,oFont16,'Detalhes da integração')
