...
IF FQ2->FQ2_TPROMA == "0"
	...
	If lMvLocBac
		_CQUERY += "  INNER JOIN " + RETSQLNAME("FPY") + " FPY ON FPY_FILIAL  =  C5_FILIAL "     + CRLF 
		_CQUERY += "  	  AND  FPY_PEDVEN   = C5_NUM "     + CRLF 
		_CQUERY += "  WHERE C5_FILIAL = '" + XFILIAL("SC5") + "'" + CRLF
		_CQUERY += "    AND FPY_PROJET = '" + ALLTRIM(FQ2->FQ2_PROJET) + "'" + CRLF 
		_CQUERY += "    AND FPY_TIPFAT = 'R'" + CRLF
		_CQUERY += "    AND FPY.D_E_L_E_T_ = ''" + CRLF
		If !Empty(cWhereFq3)
			_CQUERY += "    AND FPY_PEDVEN IN ( SELECT FPZ_PEDVEN " + CRLF
			_CQUERY += "   FROM " + RETSQLNAME("FPZ") + " FPZ" + CRLF
			_CQUERY += "  WHERE FPZ_FILIAL = '" + XFILIAL("FPZ") + "'" + CRLF
			_CQUERY += "  	AND FPZ_AS IN (" + cWhereFq3 + ") " + CRLF
			_CQUERY += "    AND FPZ.D_E_L_E_T_ = ''" + CRLF
			_CQUERY += "    ) " + CRLF
		EndIf
	Else
		_CQUERY += "  WHERE C5_FILIAL = '" + XFILIAL("SC5") + "'" + CRLF
...
_CQUERY := " SELECT FQ3_CODBEM TECG, FQ3_HORREA HORIMETRO, FQ3_QTDDIE DIESEL" + CRLF
...
_CQUERY := " SELECT FQ3_PROD , FQ3_DESPRO, SUM(FQ3_QTD) FQ3_QTD "  + CRLF
_CQUERY += " FROM " + RETSQLNAME("FQ3") + " SZ1"                + CRLF
_CQUERY += " WHERE  FQ3_FILIAL = '" + XFILIAL("FQ3")+ "'"        + CRLF
_CQUERY += "    AND FQ3_NUM    = '" + ALLTRIM(FQ2->FQ2_NUM) + "'" + CRLF
_CQUERY += "    AND FQ3_ASF    = '" + ALLTRIM(FQ2->FQ2_ASF) + "'" + CRLF
...
_CQUERY += "    AND SZ1.D_E_L_E_T_ = ''" + CRLF
_CQUERY += "  GROUP BY FQ3_PROD, FQ3_DESPRO" + CRLF
