...
Local cQuery
	...
	cQUery += " AND FPN_COD  BETWEEN '"+mv_par01+"' AND '"+mv_par02+"' "
	cQUery += " AND FPN_AS  BETWEEN '"+mv_par03+"' AND '"+mv_par04+"' "
	cQUery += " AND FPN_PROJET  BETWEEN '"+mv_par05+"' AND '"+mv_par06+"' "
	If mv_par10 == 1
		cQUery += " AND FPN_DTINIC  BETWEEN '"+DTOS(mv_par07)+"' AND '"+DTOS(mv_par08)+"' "
	Else
		cQUery += " AND FPP_DTMEDI  BETWEEN '"+DTOS(mv_par07)+"' AND '"+DTOS(mv_par08)+"' "
	EndIf	
