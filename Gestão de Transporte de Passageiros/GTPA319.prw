...
If GA319VlDic(@cMsgErro)
    FwExecView(STR0001,"VIEWDEF.GTPA319",MODEL_OPERATION_UPDATE, /*oDlg*/, {||.T.} /*bCloseOk*/, {||.T.}/*bOk*/, 5,/*aButtons*/, {||.T.}/*bCancel*/,,,) // "Contratos de Turismo - Aprovação Operacional"
Else
...
oModel:SetDescription(STR0001) // "Contratos de Turismo - Aprovação Operacional"
