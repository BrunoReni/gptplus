...
If !lRet
	oMdl:GetModel():SetErrorMessage(oMdl:GetId(),"GQE_STATUS",oMdl:GetId(),"GQE_STATUS",'VldRecurso',STR0009+cRetLog,cMsgSol ) //"Houve uma inconsistência na confirmação do Recurso: "
Endif
