...
Static Function GetQryAloca(cTabRodagem,dViagensDe,dViagensAte,lChkTarifa)
	...
	cQuery += "	AND RODAGEM.G52_LOCORI = T.G55_LOCORI " + chr(13)
	cQuery += "	AND RODAGEM.G52_LOCDST = T.G55_LOCDES " + chr(13)
	cQuery += "	AND RODAGEM.G52_HRSDRD = T.G55_HRINI " + chr(13)
	cQuery += "	AND RODAGEM.G52_HRCHRD = T.G55_HRFIM " + chr(13)
		...
		Else
			...
			If ( lAltera )
				...
				If ( oMdlGYN:GetValue('GYN_VEIC',nLineAtu) == cCodVeic )
					...
					oMdlTOT:SetValue("TOT_KMVMAX",nKmMax-(nHodoAtu+nKMViag))
