...
Begin
   ...
   while (@@Fetch_Status = 0) begin
      ...
      ------------------------------------------------------------------------------------------------------------------ */
      exec MAT051_## @IN_FILIALCOR, @cProduto, @IN_MV_CUSFIL, @IN_MV_MOEDACM, @nOUT_VLR1 OutPut, @nOUT_VLR2 OutPut, @nOUT_VLR3 OutPut, @nOUT_VLR4 OutPut, @nOUT_VLR5 OutPut
