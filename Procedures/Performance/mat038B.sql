...
/* ---------------------------------------------------------------------------------------------------------------------
    ...
    Assinatura  -  <a> 005 </a>
    Descricao   -  <d> Transferencia de Saldos nas Ordens de Produ��o </d>
    Entrada     -  <ri> @IN_FILIALCOR
                        @IN_MV_ULMES
                        @OUT_RESULTADO </ri>

    Saida       -  <ro> @OUT_RESULTADO - Houve sucesso ou n�o </ro>
    ...
    0.MAT038B - Transferencia de Saldos nas Ordens de Produ��o
