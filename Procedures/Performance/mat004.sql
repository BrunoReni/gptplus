...
begin
   ...
   If @cTudoOk = '1' begin
      ...
      EXEC MAT007_## @cFILIALCOR, @cAux, @cDINICIO, @IN_MV_LOCPROC, @IN_COPCOES, @IN_CUSUNIF, @IN_DDATABASE, @IN_MV_NEGESTR, @IN_MV_MOEDACM, @IN_MV_PAR1, @IN_MV_CUSFIFO,@cMV_PRODMNT,@IN_MV_D3SERVI,@IN_INTDL,@cMV_CQ,@IN_MVULMES,@IN_MV_WMSNEW,@IN_MV_PRODMOD, @IN_TRANSACTION, @cExecutou OUTPUT
         ...
         if ( @cD1_TIPO <> 'D' ) begin -- verifica se é uma devolução
            if ( @cF4_PODER3 = 'D' ) begin -- verifica se é uma devolução que está em poder de terceiros
               ...
               if (@cMDia = '1') begin
                  ...
                  select @cAux1 = '300'
                  select @nAux  = 0
                  EXEC MAT009_## @cAux, @cAux1, @vRecnoD1, @nRecnoSD3, @nAux, @MV_PAR14, @cMV_PAR1, @IN_MV_PRODPR0, @cFILIALCOR, @IN_RECNOSMO, @cTransf, @IN_CPAISLOC, @IN_USAFILTRF, @IN_SEQ500,@IN_MV_PRODMOD,@cMV_CQ,@IN_MV_PAR11,@IN_MV_PAR18,@IN_MV_330JCM1,@IN_MV_PROCQE6, @cB1_CCCUSTO,@IN_FILIALPROC,@cAtuNiv,@IN_TRANSACTION
                  select @cAtuNiv = '0'
               end else begin
                  select @cAux  = 'SD1'
                  select @cAux1 = '280'
                  ...
                  if ( @cD1_TIPO <> 'D' ) begin
                     if ( @cF4_PODER3 = 'D' ) begin
                        ...
                        if (@cMDia = '1') begin
                           ...
                           select @cAux  = 'SD3'
                           select @cAux1 = '300'
                           EXEC MAT009_## @cAux, @cAux1, @vRecnoD3, @vRecnoD1, @nRecTRB, @MV_PAR14, @cMV_PAR1, @IN_MV_PRODPR0, @cFILIALCOR, @IN_RECNOSMO, @cTransf, @IN_CPAISLOC, @IN_USAFILTRF, @IN_SEQ500,@IN_MV_PRODMOD,@cMV_CQ,@IN_MV_PAR11,@IN_MV_PAR18,@IN_MV_330JCM1,@IN_MV_PROCQE6, @cB1_CCCUSTO,@IN_FILIALPROC,@cAtuNiv,@IN_TRANSACTION
                        end else begin
                           /*----------------------------------------------------------
                        ...
                        if ( @nAptmPMS > 0 ) begin
                           ...
                           while ( @vContador > 0 ) begin
                              ...
                              select @cAux    = 'SD1'
                              select @nRecTRB = 0
                              EXEC MAT009_## @cAux, @cAux1, @vRecnoD1, @vRecnoD3, @nRecTRB, @MV_PAR14, @cMV_PAR1, @IN_MV_PRODPR0, @cFILIALCOR, @IN_RECNOSMO, @cTransf, @IN_CPAISLOC, @IN_USAFILTRF, @IN_SEQ500,@IN_MV_PRODMOD,@cMV_CQ,@IN_MV_PAR11,@IN_MV_PAR18,@IN_MV_330JCM1,@IN_MV_PROCQE6, ' ',@IN_FILIALPROC,@cAtuNiv,@IN_TRANSACTION
                           ...
                           select @nAux    = 0
                           select @nRecTRB = 0
                           EXEC MAT009_## @cAux, @cAux1, @vRecnoD1, @nAux, @nRecTRB, @MV_PAR14, @cMV_PAR1, @IN_MV_PRODPR0, @cFILIALCOR, @IN_RECNOSMO, @cTransf, @IN_CPAISLOC, @IN_USAFILTRF, @IN_SEQ500,@IN_MV_PRODMOD,@cMV_CQ,@IN_MV_PAR11,@IN_MV_PAR18,@IN_MV_330JCM1,@IN_MV_PROCQE6, ' ',@IN_FILIALPROC,@cAtuNiv,@IN_TRANSACTION
                           select @nRecTRB = max( R_E_C_N_O_ ) from TRB### where TRB_FILIAL = @cFILIALCOR
                           if @nRecTRB is Null select @nRecTRB = 0
                           select @cAux    = 'SD3'
                           select @cAux1   = '300'
      ...
      while (@@Fetch_Status = 0) begin
         ...
         if ( @cD2_TIPO <> 'D' ) begin
            if (@cF4_PODER3 = 'R' ) begin
               ...
               select @cAux1 = '300'
               EXEC MAT009_## @cAux, @cAux1, @vRecnoD2, @nAptmPMSTMP, @nAptmPMSTMP, @MV_PAR14, @cMV_PAR1, @IN_MV_PRODPR0, @cFILIALCOR, @IN_RECNOSMO, @cTransf, @IN_CPAISLOC, @IN_USAFILTRF, @IN_SEQ500,@IN_MV_PRODMOD,@cMV_CQ,@IN_MV_PAR11,@IN_MV_PAR18,@IN_MV_330JCM1,@IN_MV_PROCQE6, @cB1_CCCUSTO,@IN_FILIALPROC,@cAtuNiv,@IN_TRANSACTION
               select @cAtuNiv = '0'
         ...
         if (@cD3_CF in ('RE5', 'DE5' )) begin
            ...
            if @iRecCount = 0 begin
               ...
               if @vRecnoD1 = 0 begin
                  ...
                  select @cAux1 = '300'
                  select @nAux  = 0
                  EXEC MAT009_## @cAux, @cAux1, @vRecnoD3, @nAux, @nAux, @MV_PAR14, @cMV_PAR1, @IN_MV_PRODPR0, @cFILIALCOR, @IN_RECNOSMO, @cTransf, @IN_CPAISLOC, @IN_USAFILTRF, @IN_SEQ500,@IN_MV_PRODMOD,@cMV_CQ,@IN_MV_PAR11,@IN_MV_PAR18,@IN_MV_330JCM1,@IN_MV_PROCQE6, @cB1_CCCUSTO,@IN_FILIALPROC,@cAtuNiv,@IN_TRANSACTION
               end else begin
                  select @cAux  = 'SD3'
                  select @cAux1 = '300'
                  EXEC MAT009_## @cAux, @cAux1, @vRecnoD3, @vRecnoD1, @nAux, @MV_PAR14, @cMV_PAR1, @IN_MV_PRODPR0, @cFILIALCOR, @IN_RECNOSMO, @cTransf, @IN_CPAISLOC, @IN_USAFILTRF, @IN_SEQ500,@IN_MV_PRODMOD,@cMV_CQ,@IN_MV_PAR11,@IN_MV_PAR18,@IN_MV_330JCM1,@IN_MV_PROCQE6, @cB1_CCCUSTO,@IN_FILIALPROC,@cAtuNiv,@IN_TRANSACTION
               end
            end
         end else begin
            ---------------------------------------------------------------
