...
@Params l1998BI   - Indica se foi solicitada a geração no modelo 1998BI
...
Default lAutomato := .F.
	...
	MontaCabec(l1998BI, @aCabecHon, @aCabecDes, @aCabecTab, @aCabecAju, @aCabecImp, @aCabecFix) //Executa a montagem dos cabeçalhos do arquivo
