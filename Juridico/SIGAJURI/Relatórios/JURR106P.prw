...
JRelatorio(aRelat,aCabec,aSessao,J106QrPrin(cUser, cThread, aFilAtiv, cDataIni, cDataFim, cTipos, cStatus, cResp), cNomeTar, cCaminho, lAutomato) //Chamada da função de impressão do relatório em TMSPrinter
...
@param cTipos    - Tipos de follow-up
@param cStatus   - Status de follow-up
@param cResp     - Responsáveis do follow-u
