...
CLASS TJurAnexo
	...
	Data cCSSButton         // CSS dos Botões
...
/*/
//-------------------------------------------------------------------
Function JAnxDlBaseCon( cChvACB, cChvAC9, nACBIndex, cFilDest)
...
Method ExisteDoc(cDoc, cExtensao) CLASS TJurAnexo
	...
	cQuery +=          "'" + PadR( Lower( StrTran( JurLmpCpo( cDoc, .F. ), '#', cCharSub ) ), TamSx3("NUM_DOC")[1]) + "' "
