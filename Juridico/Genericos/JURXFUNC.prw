...
Else
	...
	oTipo := TJurPnlCampo():Initialize(40, 110, nTamTipoL, 22, oPanel,, cTipoLanc )
	oTipo:Activate()
	...
	oCobraLanc := TJurPnlCampo():Initialize(80, 15, 130, 25, oPanel, cTitCobLc, cTab + "_COBRAR") // Lançamento Cobrar:
	oCobraLanc:Activate()

	@ 70, 10  To  110, 250 Label clblDespTS Pixel Of oPanel

	oCobraTipo := TJurPnlCampo():Initialize(130, 15, 130, 25, oPanel, STR0211, cCpoTipoCb) // "Marcados como 'Cob. Padrão' igual a: "
	oCobraTipo:Activate()

	oCobraCli  := TJurPnlCampo():Initialize(160, 15, 130, 25, oPanel, STR0212, cTab + "_COBRAR") // "Classificados no Cliente como cobrável igual a: "
	oCobraCli:Activate()

	oCobraCont := TJurPnlCampo():Initialize(190, 15, 130, 23, oPanel, STR0220, cTab + "_COBRAR") // "Classificados no Contrato como cobrável igual a: "
	oCobraCont:Activate()

	@ 120, 10  To  215, 250 Label clblTpDsAt Pixel Of oPanel
EndIf
...
If lRet
	If !lWebAppJob  .And. cResult $ "1|2" // Resultado do relatório: '1' - Impressora / '2' - Tela / '3' - Word / '4' - Nenhum
