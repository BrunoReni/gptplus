...
aWizParam := Array( 6 ) //posições dos agrupadores
lValid    := .T.
...
Else
	ApMsgAlert( I18N( STR0002, { SM0->M0_CODIGO } ), STR0001 ) //"Uma ou mais funções não foram encontradas para execução do Wizard. Verifique se o ambiente possui a expedição contínua do módulo Financeiro com o pacote de programas (LIB) mais recente." # "Wizard Mais Negócios"
	lValid := .F.
EndIf
...
Static Function MakeStep1( aWizParam As Array ) As Logical
	...
	@ 01, 10 SAY STR0004 OF oPanel PIXEL FONT oCHFont   //"Defina os dados que serão utilizados para a integração com a Supplier"
	...
	@ 63, 15 SAY STR0006 OF oPanel PIXEL FONT oCHFont   //"Código:"
	...
	@ 105, 15 SAY STR0006 OF oPanel PIXEL FONT oCHFont  //"Código:"
	@ 115, 15 MSGET oClient VAR aWizParam[ BANK ][ ENT_CODE ]  SIZE 40, 10 OF oPanel Font oCMFont PIXEL WHEN !lExistSA6

	@ 105, 60 SAY STR0013 OF oPanel PIXEL FONT oCHFont  //"Agência:"
	...
	@ 162, 10 GROUP TO 201, 353 PROMPT STR0016 OF oPanel PIXEL    //'Carteira Devolução - Pós Faturamento'

	@ 172, 15 SAY STR0006 SIZE 200, 20 OF oPanel PIXEL FONT oCHFont //"Código"
	...
	@ 172, 54 SAY STR0017  SIZE 250, 20 OF oPanel PIXEL FONT oCHFont //"Descrição"
	@ 182, 54 MSGET oDescSitCob VAR aWizParam[ BILLING ][ ENT_STORE ] SIZE 200, 9 OF oPanel PIXEL PICTURE "@!" WHEN .F.

	@ 204, 10 GROUP TO 248, 353 PROMPT STR0058 OF oPanel PIXEL    //'Configuração do Schedule'

	@ 214, 15 SAY STR0059 SIZE 200, 20 OF oPanel PIXEL FONT oCHFont //"Escolha a opção desejada:"
	...
	@ 255,313 BUTTON STR0018 SIZE 040, 015 PIXEL OF oPanel ACTION ( FWMsgRun( ,{ || lValid := VldStep1( aWizParam, @oAntecipa ) }, Nil, STR0019 ), oPanel:End() ) // "Finalizar" # "Ativando a integração"
