...
Function Rsk20DiaB()
	...
	oDlg := MSDialog():New( 180, 180, 280, 500, STR0028,,,,, CLR_BLACK, CLR_WHITE,,, .T. )  //"2ª via do Boleto"
...
Function RskStAr2() as Character
   ...
   cStatusAr2 :=  STR0093 //"1=Receber;2=Taxa;3=Bonificação;4=Prorrogação;5=Devolução;6=Bloqueia NCC;7=Libera NCC;8=NCC Baixa Parcial;9=NCC Baixa Total;A=Cancelada;B=NCC Inativa"
Return cStatusAr2
