...
Static Function ModelDef()
	...
	aAdd(aCampos,{"MV_DSOFDT" , "Data Transação Documento Fiscal"                  	, "C", 01 , 0,,{"","1=Entrada","2=Financeira","3=Informada"}, {|| SuperGetMV('MV_DSOFDT',,'1') }, })
	...
	If GFXPR12117("MV_PDGPIS")// Não localizado uso dentro dos fontes.
		aAdd(aCampos,{"MV_PDGPIS" , "Pedágio PIS/COFINS"							, "C", 01 , 0,,{"","1=Sim", "2=Não"} ,{|| SuperGetMv("MV_PDGPIS",.F.,"2") }, } )
	EndIf
	...
	If GFXPR12130("MV_GFEROTR")// Não localizado uso dentro dos fontes.
		aAdd(aCampos,{"MV_GFEROTR" , "Dt liberação Romaneio e Transportador obrigatórios", "C", 01 , 0,,{"","1=Sim", "2=Não"} ,{|| SuperGetMv("MV_GFEROTR",.F.,"1") }, } )
	EndIf
	...
	If GFEA065INP()
		aAdd(aCampos,{"MV_TESGFE" , "TES Doc. Frete"								, "C", 01 , 0,,{"","1=Atribuído.Sistema","2=Informado.Usuário"} 				,{|| SuperGetMv("MV_TESGFE",.F.,"1") }, })
...
Static Function ViewDef()
	...
	If GFXPR12117("MV_GFEGVR")
		aAdd(aCampos,{"MV_GFEGVR", "Realizar a busca de tabelas de frete considerando a tabela GVR (Região x Regiões)?"         , "C", "@!"            ,           , "CalcFret", "GrpPerfFr"     	, {"","1=Sim","2=Não"} , .T.})
		aAdd(aCampos,{"MV_GFEGUL", "Realizar a busca de tabelas de frete considerando a tabela GUL (Região x Faixa de CEP)?"    , "C", "@!"            ,           , "CalcFret", "GrpPerfFr"     	, {"","1=Sim","2=Não"} , .T.})
		aAdd(aCampos,{"MV_GFEVIN", "Realizar a busca de tabelas de frete considerando tabelas de tipo vínculo?"                 , "C", "@!"            ,           , "CalcFret", "GrpPerfFr"     	, {"","1=Sim","2=Não"} , .T.})
	EndIf
	...
	aAdd(aCampos,{"MV_CDTPOP" , "Tipo Operação Padrão"                          		, "C", "@!"            , "GV4"     , "IntProt" , "GpOms"      	,                                                                                           , .T.})
	...
	aAdd(aCampos,{"MV_DSOFDT" , "Data Transação Documento Fiscal"               		, "C", "@!"            ,           , "IntDS"   , "GrpFsc"     	, {"","1=Entrada","2=Financeira","3=Informada"}                                                , .T.})
	...
	If GFEA065INP()
		aAdd(aCampos,{"MV_TESGFE" , "TES Doc. Frete"									, "C", "@!" 			, 			, "IntProt"	, "GpMate"		, {"","1=Atribuído.Sistema", "2=Informado.Usuário"}										, })
