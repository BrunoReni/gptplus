...
Main Function GFEX011()
	...
	DEFINE MSDIALOG oDlg TITLE "Simulação de Fretes Simplificada" ;
   	...
   	@ aPosEnch[1]+002, aPosEnch[2]+020 SAY oSay1  PROMPT "Tipo Operação" 		  	SIZE 050, 010 OF oDlg COLORS 0, 16777215 PIXEL
   	@ aPosEnch[1]+002, aPosEnch[2]+240 SAY oSay2  PROMPT "Classificação Frete" 		SIZE 050, 010 OF oDlg COLORS 0, 16777215 PIXEL
   	@ aPosEnch[1]+027, aPosEnch[2]+020 SAY oSay8  PROMPT "Tipo de Veículo"        	SIZE 050, 010 OF oDlg COLORS 0, 16777215 PIXEL 
   	@ aPosEnch[1]+053, aPosEnch[2]+020 SAY oSay3  PROMPT "Valor Total Carga" 	 	SIZE 057, 010 OF oDlg COLORS 0, 16777215 PIXEL
   	@ aPosEnch[1]+053, aPosEnch[2]+087 SAY oSay4  PROMPT "Peso Total Carga (Kg)"   	SIZE 078, 010 OF oDlg COLORS 0, 16777215 PIXEL
   	@ aPosEnch[1]+053, aPosEnch[2]+145 SAY oSay7  PROMPT "Volume Total Carga (m³)"	SIZE 078, 010 OF oDlg COLORS 0, 16777215 PIXEL
   	@ aPosEnch[1]+053, aPosEnch[2]+220 SAY oSay10 PROMPT "Percurso (Km)" 		  	SIZE 078, 010 OF oDlg COLORS 0, 16777215 PIXEL
    @ aPosEnch[1]+077, aPosEnch[2]+020 SAY oSay6  PROMPT "Cod. Remetente" 		  	SIZE 057, 010 OF oDlg COLORS 0, 16777215 PIXEL 
   	@ aPosEnch[1]+077, aPosEnch[2]+257 SAY oSay5  PROMPT "Cod. Destinatário"       	SIZE 057, 010 OF oDlg COLORS 0, 16777215 PIXEL
   	@ aPosEnch[1]+102, aPosEnch[2]+020 SAY oSay9  PROMPT "Considera Negociação?"    SIZE 065, 010 OF oDlg COLORS 0, 16777215 PIXEL
   	@ aPosEnch[1]+127, aPosEnch[2]+020 SAY oSay11 PROMPT "Cidade Origem"       		SIZE 057, 010 OF oDlg COLORS 0, 16777215 PIXEL
   	@ aPosEnch[1]+127, aPosEnch[2]+257 SAY oSay12 PROMPT "Cidade Destino"       	SIZE 057, 010 OF oDlg COLORS 0, 16777215 PIXEL
   	@ aPosEnch[1]+152, aPosEnch[2]+020 SAY oSay13 PROMPT "Transportador"       		SIZE 057, 010 OF oDlg COLORS 0, 16777215 PIXEL
  
  
   	@ aPosEnch[1]+012, aPosEnch[2]+020 MSGET oGet1     VAR cTpOp 	  SIZE 045, 010 OF oDlg PICTURE "@!" COLORS 0, 16777215 F3 "GV4" Valid GFEX011Desc(1,cTpOp,@cDesTpOp) PIXEL hasbutton
   	@ aPosEnch[1]+012, aPosEnch[2]+070 MSGET oGet2     VAR cDesTpOp   SIZE 156, 010 OF oDlg PICTURE "@!" COLORS 0, 16777215 READONLY PIXEL
   	@ aPosEnch[1]+012, aPosEnch[2]+240 MSGET oGet3     VAR cCdClFr 	  SIZE 045, 010 OF oDlg PICTURE "@!" COLORS 0, 16777215 F3 "GUB" Valid GFEX011Desc(2,cCdClFr,@cDesClFr) PIXEL hasbutton
	@ aPosEnch[1]+012, aPosEnch[2]+290 MSGET oGet4     VAR cDesClFr   SIZE 156, 010 OF oDlg PICTURE "@!" COLORS 0, 16777215 READONLY PIXEL 
	@ aPosEnch[1]+037, aPosEnch[2]+020 MSGET oGet12    VAR cCdTpVc 	  SIZE 045, 010 OF oDlg PICTURE "@!" COLORS 0, 16777215 F3 "GV3" Valid GFEX011Desc(4,cCdTpVc,@cDesTpVc) PIXEL hasbutton
	@ aPosEnch[1]+037, aPosEnch[2]+070 MSGET oGet13    VAR cDesTpVc   SIZE 156, 010 OF oDlg PICTURE "@!" COLORS 0, 16777215 READONLY PIXEL     
   	@ aPosEnch[1]+063, aPosEnch[2]+020 MSGET oGet5     VAR nVlFrt  	  SIZE 055, 010 OF oDlg PICTURE PESQPICT("GW8", "GW8_VALOR") COLORS 0, 16777215 PIXEL hasbutton
   	@ aPosEnch[1]+063, aPosEnch[2]+087 MSGET oGet6     VAR nPsReal 	  SIZE 055, 010 OF oDlg PICTURE PESQPICT("GW8", "GW8_PESOR") COLORS 0, 16777215 PIXEL hasbutton
   	@ aPosEnch[1]+063, aPosEnch[2]+145 MSGET oGet11    VAR nVolume 	  SIZE 055, 010 OF oDlg PICTURE PESQPICT("GW8", "GW8_VOLUME") COLORS 0, 16777215 PIXEL hasbutton
   	@ aPosEnch[1]+063, aPosEnch[2]+220 MSGET oGet14    VAR nDistan 	  SIZE 055, 010 OF oDlg PICTURE PESQPICT("GWN", "GWN_DISTAN") COLORS 0, 16777215 PIXEL hasbutton
    @ aPosEnch[1]+087, aPosEnch[2]+020 MSGET oGet7     VAR cCodRem 	  SIZE 060, 010 OF oDlg PICTURE "@!" COLORS 0, 16777215 F3 "GU3" Valid GFEX011Desc(3,cCodRem,@cDesRem) PIXEL hasbutton
   	@ aPosEnch[1]+087, aPosEnch[2]+087 MSGET oGet8     VAR cDesRem 	  SIZE 155, 010 OF oDlg PICTURE "@!" COLORS 0, 16777215 READONLY PIXEL
   	@ aPosEnch[1]+087, aPosEnch[2]+257 MSGET oGet9     VAR cCodDes 	  SIZE 060, 010 OF oDlg PICTURE "@!" COLORS 0, 16777215 F3 "GU3" Valid GFEX011Desc(3,cCodDes,@cDsDest)PIXEL hasbutton
   	@ aPosEnch[1]+087, aPosEnch[2]+317 MSGET oGet10    VAR cDsDest 	  SIZE 155, 010 OF oDlg PICTURE "@!" COLORS 0, 16777215 READONLY PIXEL
    @ aPosEnch[1]+112, aPosEnch[2]+020 COMBOBOX oCombo VAR cSitTab    ITEMS aCombo	SIZE 080, 010 OF oDlg  COLORS 0, 16777215 PIXEL 
    @ aPosEnch[1]+137, aPosEnch[2]+020 MSGET oGet15    VAR cCidOri 	  SIZE 060, 010 OF oDlg PICTURE "@!" COLORS 0, 16777215 F3 "GU7GUA" Valid GFEX011Desc(5,cCidOri,@cDsCidOri) PIXEL hasbutton
   	@ aPosEnch[1]+137, aPosEnch[2]+087 MSGET oGet16    VAR cDsCidOri  SIZE 155, 010 OF oDlg PICTURE "@!" COLORS 0, 16777215 READONLY PIXEL
   	@ aPosEnch[1]+137, aPosEnch[2]+257 MSGET oGet17    VAR cCidDest   SIZE 060, 010 OF oDlg PICTURE "@!" COLORS 0, 16777215 F3 "GU7GUA" Valid GFEX011Desc(5,cCidDest,@cDsCidDest) PIXEL hasbutton
   	@ aPosEnch[1]+137, aPosEnch[2]+317 MSGET oGet18    VAR cDsCidDest SIZE 155, 010 OF oDlg PICTURE "@!" COLORS 0, 16777215 READONLY PIXEL
   	@ aPosEnch[1]+162, aPosEnch[2]+020 MSGET oGet19    VAR cCdTrp 	  SIZE 060, 010 OF oDlg PICTURE "@!" COLORS 0, 16777215 F3 "GU3TRP" Valid GFEX011Desc(3,cCdTrp,@cDsTrp) PIXEL hasbutton
    @ aPosEnch[1]+162, aPosEnch[2]+087 MSGET oGet20    VAR cDsTrp 	  SIZE 155, 010 OF oDlg PICTURE "@!" COLORS 0, 16777215 READONLY PIXEL
