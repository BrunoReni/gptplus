...
Default cNFiscal  := ""
	...
	Else
		...
		If cPaisLoc <> "BRA" .AND. Empty(cNFiscal) .And. AllTrim(cEspecD2) == 'RTS' .And. !Empty(nRecnoSD2) .AND. FWIsInCallStack("MATA462TN")
			lRet := oEstEnder:UndoFtMi(nRecnoSd2,!lEstPed)
		Else
			If !Empty(cNFiscal) 
