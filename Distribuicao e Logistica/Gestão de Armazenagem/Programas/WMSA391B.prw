...
Local lExistBloc := ExistBlock("WMS391BM")
	...
	ADD OPTION aRotina TITLE STR0001 ACTION "StaticCall(WMSA391B,Volume)"     OPERATION 3 ACCESS 0 // Montar Volume
	ADD OPTION aRotina TITLE STR0002 ACTION "StaticCall(WMSA391B,ImpVolume)"  OPERATION 9 ACCESS 0 // Imprimir Etiqueta
	ADD OPTION aRotina TITLE STR0011 ACTION "StaticCall(WMSA391B,ImpTodos)"   OPERATION 9 ACCESS 0 // Imprimir Todos
	ADD OPTION aRotina TITLE STR0003 ACTION "StaticCall(WMSA391B,EstVolume)"  OPERATION 4 ACCESS 0 // Estornar Volume
