...
Local aColsSX3  := {}
	...
	oStrD0OFld:SetProperty("D0O_CODPRO",MODEL_FIELD_VALID,FWBuildFeature(STRUCT_FEATURE_VALID,"StaticCall(WMSA395A,ValidField,A,B,C)"))
	oStrD0OFld:SetProperty("D0O_LOTECT",MODEL_FIELD_VALID,FWBuildFeature(STRUCT_FEATURE_VALID,"StaticCall(WMSA395A,ValidField,A,B,C)"))
	oStrD0OFld:SetProperty("D0O_NUMLOT",MODEL_FIELD_VALID,FWBuildFeature(STRUCT_FEATURE_VALID,"StaticCall(WMSA395A,ValidField,A,B,C)"))

	oStrD0OFld:SetProperty("D0O_LOTECT",MODEL_FIELD_WHEN,FwBuildFeature(STRUCT_FEATURE_WHEN,"StaticCall(WMSA395A,WhenField,A,B)"))
	oStrD0OFld:SetProperty("D0O_NUMLOT",MODEL_FIELD_WHEN,FwBuildFeature(STRUCT_FEATURE_WHEN,"StaticCall(WMSA395A,WhenField,A,B)"))
