...
Private aRotina := {}
	...
	ADD OPTION aRotina TITLE STR0009 ACTION "StaticCall(WMSA570,Monitor)"   OPERATION 2 ACCESS 0 // "Monitor"
	ADD OPTION aRotina TITLE STR0010 ACTION "StaticCall(WMSA570,GerarOS)"   OPERATION 2 ACCESS 0 // "Gerar OS"
	ADD OPTION aRotina TITLE STR0011 ACTION "StaticCall(WMSA570,ExcluirOS)" OPERATION 5 ACCESS 0 // "Excluir OS"
