...
Local aRotina := {}
	ADD OPTION aRotina TITLE STR0055 ACTION "StaticCall(WMSA412,Monitor)" OPERATION 2 ACCESS 0 //Monitor
Return aRotina
//-------------------------------------------------------------------//
//-------------------------Funcao ModelDef---------------------------//
//-------------------------------------------------------------------//
...
Local cAliasD04:= Nil
	...
	If lOk
		Begin Transaction
			...
			StaticCall(WMSV102,GrvEstorno,,,,,,,,,,,,aDados)
		End Transaction
	EndIf
	RestArea(aAreaD01)
	RestArea(aAreaD02)
