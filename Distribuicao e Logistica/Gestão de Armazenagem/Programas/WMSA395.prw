...
Local aRotina := {}
	ADD OPTION aRotina TITLE STR0002 ACTION "StaticCall(WMSA395,Monitor)"   OPERATION 2 ACCESS 0 // Monitor
	ADD OPTION aRotina TITLE STR0012 ACTION "StaticCall(WMSA395,GerVolAut)" OPERATION 2 ACCESS 0 // Gerar Volume
	ADD OPTION aRotina TITLE STR0003 ACTION "StaticCall(WMSA395,GerPedVol)" OPERATION 2 ACCESS 0 // Gerar Pedido
Return aRotina
