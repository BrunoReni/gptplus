...
Local oModel   := MPFormModel():New('WMSA332C',/*bPreValidacao*/,{|oModel| PosVldMdl(oModel) },{|oModel| CommitMdl(oModel) },/*bCancel*/)
	...
	oStruCBA:SetProperty('CBA_LOCALI',MODEL_FIELD_VALID, FWBuildFeature( STRUCT_FEATURE_VALID, 'StaticCall(WMSA332C,ValEndInv,A,B)' ) ) 
...
Static Function ValEndInv(oModel,cField)
Local lRet := .T.
