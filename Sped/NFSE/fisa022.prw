...
Else
	...
	aadd(aPerg2,{1,STR0087,aParam[3],"",".T.","",".T.",120,.F.})	//"Senha"
		...
		If cCodMun $ "4321634-2925303-3118601-3203205-2921005-3117504-1702109-2800308-3503307-3538709-3300704-1400100-3156700-4303905-3302403-3148103-3146107-4308201-3304508-3541406-3171204-2301000-4315602-1100205-3200607-3301900-4107652-3305505-2301109-3524907-4313300-4102307-4119152-4317202-4201307-4105805-3302601-4118204-3200300-3510807-3169901-5213103-3551702-2909307-2928901-3305000-4104204-3510807-3505500-3306305-3510609-3555000-3549102-2919553-5007901" .Or. cCodMun $ Fisa022Cod( "004" ) .or. cCodMun $ Fisa022Cod( "006" ) .or. cCodMun $ Fisa022Cod( "011" ) .or. cCodMun $ Fisa022Cod( "012" ) .or. cCodMun $ Fisa022Cod( "016" )	.or. cCodMun $ Fisa022Cod( "027" ) 
		...
		ElseIf cCodMun $ "3534401-2707701-2803500-3120904" + Fisa022Cod("009")+Fisa022Cod("010")+Fisa022Cod("015") + fisa022Cod( "029" )
		...
		ElseIf cCodMun $ Fisa022Cod("012")
			...
			@ 010,210 SAY STR0219 SIZE 270,010 PIXEL OF oWizard:oMPanel[4] //"Cod. Validação"
		...
		elseIf( cCodMun $ Fisa022Cod("005") .Or. cCodMun $ Fisa022Cod("019") + "-5206206-4314407-3507506") //GO - Cristalina / SC - Pelotas
			...
			@ 100,110 SAY STR0217 SIZE 270,010 PIXEL OF oWizard:oMPanel[4]  //"Chave de Autenticação"
			@ 110,110 GET cChaveAut SIZE 110,010 PIXEL OF oWizard:oMPanel[4]
		elseIf(( cCodMun == "4304408" ) .Or. cCodMun $ Fisa022Cod("020") .or. cCodMun $ Fisa022Cod( "022" ) +"-4125506-3205069-2307700-3117876-3300605-1100023-3545308-3511102-3531308-3525300-4304903-2101251" )// Canela - RS + FGMAISS + São José de Ribamar
			@ 040,110 SAY STR0221 SIZE 270,010 PIXEL OF oWizard:oMPanel[4]  //"Usuário"
			@ 050,110 GET oUsuario VAR cUsuario SIZE 080,010 PIXEL OF oWizard:oMPanel[4]

			@ 070,110 SAY STR0212 SIZE 270,010 PIXEL OF oWizard:oMPanel[4]  //"Senha"
			@ 080,110 GET cSenha SIZE 080,010 PIXEL OF oWizard:oMPanel[4] PASSWORD
		elseIf( cCodMun $ "4101507-4303509-2903201-2917508-2914000-4314803-4313409-2925204" ) // Arapongas - PR
			@ 040,110 SAY STR0221 SIZE 270,010 PIXEL OF oWizard:oMPanel[4]  //"Usuário"
			@ 050,110 GET oUsuario VAR cUsuario SIZE 080,010 PIXEL OF oWizard:oMPanel[4]
...
Static Function SetParams(cIdEnt, cUrl, cCodMun, cAmbienteNFSe, cModNFSE, cVersaoNFSe, cCodSIAFI, cCnpJAut, cUsuario, cSenha, nGrava,cAEDFe,cModelo,cChaveAut,cClientID,cSecretID,cFtpT)
	...
	If cCodMun $ Fisa022Cod("013") .Or. (cCodMun $ Fisa022Cod("202") .And. cCodMun $ GetMunNFT())	//NFTS e NFSE E-Transparencia - Petrópolis/RJ (NFTS) / Limeira/SP (NFSE)
		oWS:cLogin 				:= AllTrim(cUsuario)				//Código de usuário
		oWS:cChaveAutenticacao 	:= Alltrim(cChaveAut)			//Código de contribuinte
	ElseIf ( cCodMun $ "4321634-2925303-3118601-3503307-3538709-3300704-1400100-3156700-4303905-3302403-3148103-3146107-4308201-3304508-3541406-2301000-3305505-2301109-4313300-4102307-3524907-3200607-3302601-3200300-3510807-3551702-2909307-2928901-3305000-5213103-3505500-3306305-3510609-3555000-3549102-3205069-3117876-3300605-1100023-3545308-3511102-2919553-3531308-5007901-3525300-4304903-2101251" .Or. cModelo $ "004-011-016") .And. cVerTSS >= "1.33" // Osasco - Campo Bom-RS - Farroupilha-RS e SIMPLISS 
		oWS:cLogin := AllTrim(cUsuario)
		oWS:cPass  := AllTrim(cSenha)
	ElseIf cCodMun == "2111300"    
		oWS:cAutorizacao := Alltrim(cAEDFe)
	//Tratamento para Osasco - SP
	ElseIf cCodMun $ "3534401-3526803-2707701-2803500"+Fisa022Cod("009")+Fisa022Cod("010")+Fisa022Cod("015")
	...
	ElseIf cCodMun $ Fisa022Cod("012") .Or. cCodMun $ "3171204"
		...
		oWS:cPass  := AllTrim(cSenha)
		oWS:cAutorizacao := Alltrim(cAEDFe)
	ElseIf cCodMun $ Fisa022Cod("014") .or. cCodMun $ "3144805-3515004-3129806-3131901-4314407"
		oWS:cLogin := AllTrim(cUsuario)
		oWS:cPass  := AllTrim(cSenha)
		oWS:cChaveAutenticacao := Alltrim(cChaveAut)
	...
	ElseIf cCodMun $ "4304408" .or. cCodMun $ Fisa022Cod("020") .or. cCodMun $ Fisa022Cod("022") + "-4125506" // RS - Canela - Fisa022Cod( "002" ) FGMAISS + São José de Ribamar
		oWS:cLogin := allTrim( cUsuario )
		oWS:cPass  := allTrim( cSenha )
	ElseIf cCodMun $ "4101507-4303509-2903201-2307700-2917508-2914000-4314803-4313409-2925204" + Fisa022Cod( "027" ) + Fisa022Cod( "028" ) + fisa022Cod( "030" )// PR - Arapongas
		oWS:cLogin := allTrim( cUsuario )
		oWS:cPass  := allTrim( cSenha )	
	ElseIf cCodMun $ "3526902-3109303-3120904" // Limeira - SP //Radu + 3109303 Buritis/MG
...
If (cCodmun $ Fisa022Cod( "010" ) + "-3524006" ) .and. !( cCodmun $ "5221858" )
	lRet := .T. 
EndIf 
