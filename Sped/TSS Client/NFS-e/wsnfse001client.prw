...
WSMETHOD CFGAMBNFSE001 WSSEND cUSERTOKEN,cID_ENT,nAMBIENTENFSE,nMODNFSE,cVERSAONFSE,cCODMUN,cCODSIAFI,cUSO,cMAXLOTE,nCNPJAUT,cENVSINC,cLOGIN,cPASS,cAUTORIZACAO,cChaveAutenticacao,cTOKENID,cCLIENTID,cCLIENTSECRET WSRECEIVE cCFGAMBNFSE001RESULT WSCLIENT WSNFSE001
Local cSoap := "" , oXmlRet
...
cSoap += WSSoapValue("CNPJAUT", ::nCNPJAUT, nCNPJAUT , "integer", .F. , .F., 0 , NIL, .F.) 
