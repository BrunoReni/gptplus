...
Do Case
    ...
    Case cPageNum == "4"
        ...
        oNewPag:SetNextAction({|| lNext_04, HandleFinish(@oDlg)})
...
Static Function JsToAdvpl(oWebChannel,cType,cContent)
    ...
    Do Case
        ...
        Case cType == "preLoad"
            ...
            cDataBase  := '{"dataBase":"' + DtoC(dDataBase) + '"}' 
            ...
            oWebChannel:AdvPLToJS('setDataBase',    cDataBase)
    EndCase
...
Local cAppEnvironment       := GetPvProfString( 'GENERAL', 'APP_ENVIRONMENT', 'NOT FOUNDED' , GetSrvIniName())
...
IF (Upper(cAppEnvironment) == 'NOT FOUNDED' .OR. Upper(cAppEnvironment) != Upper(GetEnvServer()))
    oEnvi["label_key_text_app_environment"] := STR0055 //Chave app_environment não configurada.
ENDIF
...
If !VldProcSB2()
    oEnvi["label_routine_text_STOREDPROCEDURE19"] := STR0073 //O parâmetro MV_A330SB2 foi alterado. Reinstale a procedure 19.
EndIf
            ...
            If oError["environment"]:HasProperty(cAux)
                ...
                Do Case 
                    ...
                    Case cAux == "label_routine_text_STOREDPROCEDURE19"
                        oPage["say"]["label_routine_text_STOREDPROCEDURE19"]:SetText(STR0073) //O parâmetro MV_A330SB2 foi alterado. Reinstale a procedure 19.
                EndCase
            Else 
                If !(cAux $ "label_key_text_logprofiler,label_routine_text_STOREDPROCEDURE19")
                    oPage["svg"][cAux]:LoadSVG( SvgCheck() ) 
...
Static Function EnvironOk()
    ...
    lRet := Len(oError["environment"]:GetNames()) == 0 .And.;
            Len(oError["dictionary"]:GetNames())  == 0 .And.;
            Len(oError["rpo"]:GetNames()) == 0
