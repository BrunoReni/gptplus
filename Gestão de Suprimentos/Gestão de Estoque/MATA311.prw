...
If A311QtdTrs(oModelNNT,2) > 0
	...
	For nx :=1 to Len(aDadosF)
		If nx == 1 .Or. (aDadosF[nx,1] # aDadosF[nx-1,1])
			...
			Else	
				Sx5NumNota(@cSerie,cTpNrFfs,cFilAnt) //cSerNF,cTpNrNfs,cFilTela,cTab,cAliTp,cSerieId,dDEmissao
			EndIf
