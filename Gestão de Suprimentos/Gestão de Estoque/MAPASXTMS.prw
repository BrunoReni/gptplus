...
Function MAPASXTMS(oMapasPF,cMapCfop)
    ...
    While !(cAlias)->(EoF())
        ...
        aRecTN[11] := cCnpjOrig
        aRecTN[12] := cNomeOrig
        aRecTN[13] := "P" // No momento, o cenário de Armazenagem Terceirizada não será coberto
        aRecTN[14] := "P" // No momento, o cenário de Armazenagem Terceirizada não será coberto
