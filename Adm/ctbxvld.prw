...
Local cPerIni 		:= ""
Local cPerFim 		:= ""
Local aParChgQRY    := {}  //Parâmetros da ChangeQuery
Local dDataAux      // DataAuxiliar para FINA210
Local nI            := 1
...
Local cSeqLan	:= ""
Local cSeqHis	:= "001"
Local nLinMax   := CtbLinMax(SuperGetMv("MV_NUMLIN"))
Local dDataL 
Local cLot		:= ""
Local cSublot   := ""
Local cAntSeqLan:= TMP->CT2_SEQLAN
...
lRet := CtbAmarra(M->CTQ_CTCPAR,M->CTQ_CCCPAR,M->CTQ_ITCPAR,M->CTQ_CLCPAR,.T.)
Return(lRet)
