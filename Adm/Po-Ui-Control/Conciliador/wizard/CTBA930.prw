...
If SuperGetMv("MV_PRJOVER",.F.,.F. )	
	...
	EndIf
Else
	C930MsgBox(STR0066+CRLF+STR0067) //"Parâmetro MV_PRJOVER (tipo L) não encontrado ou com conteúdo F." //"Crie ou ative esse parâmetro para prosseguir."
EndIf
...
Monta teta com os dados de rastreamento contábil CV3
