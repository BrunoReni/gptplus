...
Local cCadastro:= STR0001  		//"ConsolidaáÑo de Empresas / Filiais"
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±⁄ƒƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒƒƒƒƒø±±
±±≥ FunáÖo    ≥Ct231RCons≥ Autor  ≥ Marcelo Akama           ≥ Data 26.05.09≥±±
±±√ƒƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¥±±
±±≥ DescriáÖo ≥ Aglut dos lancamentos de acordo com roteiro de consolidacao≥±±
±±√ƒƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¥±±
...
±±≥  Uso      ≥ SigaCTB                                                    ≥±±
±±√ƒƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¥±±
±±≥ ParÑmetros≥ExpD1 = Data Inicial (se nil, saldo inicial ate data final) ≥±±
±±≥           ≥ExpD2 = Data Final                                          ≥±±
±±≥           ≥ExpC1 = Moeda                                               ≥±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±⁄ƒƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒƒƒƒƒø±±
±±≥ FunáÖo    ≥Ct231SldCn≥ Autor  ≥ Marcelo Akama           ≥ Data 25.05.09≥±±
±±√ƒƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¥±±
±±≥ DescriáÖo ≥ Aglutinacao dos saldos/lancamentos             			   ≥±±
±±√ƒƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¥±±
...
±±√ƒƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒ¥±±
±±≥ DescriáÖo ≥ Grava no Arq. de Trabalho os mov. debito/credito.          ≥±±
±±√ƒƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¥±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±⁄ƒƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒƒƒƒƒø±±
±±≥ FunáÖo    ≥Ct231ExecP≥ Autor  ≥ Marcelo Akama           ≥ Data 16.06.09≥±±
±±√ƒƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¥±±
±±≥ DescriáÖo ≥ Aglutinacao dos saldos/lancamentos             			   ≥±±
±±√ƒƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¥±±
...
Local cProc		:= 'CTB231_P'+CriaTrab(nil,.F.)
Local cSQL		:= ''
Local aResult	:= {}
...
Local cEntidade	:= ""
Local nZ		:= 0
Local cSQLOld	:= "" // Vari·vel utilizada para manter as informaÁıes da procedure antes do PE
...
If !TCSPExist( cProc )
	...
	cSQL:=cSQL+"declare @recUNQ 	int"+CRLF
	cSQL:=cSQL+""+CRLF
	...
	Else
		...
		cSQL:=cSQL+"					select @recUNQ=isnull(max(R_E_C_N_O_),0)+1 from "+cTmpUNQ+CRLF
		cSQL:=cSQL+"					insert into "+cTmpUNQ+" ( CT2_FILIAL, CT2_DATA, CT2_LOTE, CT2_SBLOTE, CT2_DOC, CT2_SBLNEW, R_E_C_N_O_ )"+CRLF
		cSQL:=cSQL+"					values ( '"+xFilial('CT2')+"', @data, @lote, @sub, @doc, @cSub_Lote, @recUNQ )"+CRLF
		cSQL:=cSQL+"				  end 
	...
	/* Ponto de Entrada para minipulaÁ„oo das informaÁıes de origem, esta demanda foi disponibilizada pois o cliente tinha necessidade de levar o complemento do histÛrico completo para a consolidadora	*/
...
cTmpUNQ:= CriaTrab( nil, .F. )

MsErase(cTmpUNQ,,"TOPCONN")
MsCreate(cTmpUNQ, aStruct, 'TOPCONN' ) 
dbUseArea( .T., 'TOPCONN', cTmpUNQ, cTmpUNQ, .T., .F. ) 
dbSelectArea( cTmpUNQ )
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±⁄ƒƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒƒƒƒƒø±±
±±≥ FunáÖo    ≥Ct231SlInP≥ Autor  ≥ Marcelo Akama           ≥ Data 30.06.09≥±±
±±√ƒƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¥±±
±±≥ DescriáÖo ≥ Gera lancamentos de saldo inicial             			   ≥±±
±±√ƒƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¥±±
...
If !TCSPExist( cProc )
	...
	if cSQL=''
		...
		If TcGetDB()='ORACLE'
			...
			cSQL:=StrTran(cSQL, " <> ''", " is not null")
		EndIf
		//Remover "VALUES ( " da string cSQL apÛs passar pelo parser, se a string posterior for diferente de "'"
