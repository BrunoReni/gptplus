...
//Verifica se o CT2 é compartilhado
...
// Trecho localizado COL|PER variável static.
If lEntidad05
...
While TRB->(!Eof())
    ...
    If nSaldo <> 0
		...
		If lFirst .or. nLinha > nMAX_LINHA .or. TRB->TPSALDO <> cTpSldAnt .or. TRB->MOEDA <> cMoedAnt
			...
			cDoc   := IIF(nLinha > nMAX_LINHA .And. !lFirst .And. TRB->MOEDA == cMoedAnt, Soma1(cDoc), cDoc) //Identifica se está na ultima linha do maximo, soma1 no numero de documento
		...
		If lCadastro
			...
			cEnt05LP	:= cSpacE05 //cSpacE05 estará vazio no padrão, somente é preenchido localizado COL|PER
			// Trecho localizado COL|PER variável static.
		...
		If nSaldo > 0					/// SE O SALDO FOR A CREDITO / CREDOR
			...
			If lEntidad05 // Trecho localizado COL|PER variável static.
		...
		If TRB->MOEDA == "01"
			...
			If !lEntidad05 //Trecho não localizado (negação)
...
If lGravouLan .And. lResultado // lResultado no padrão deve ser sempre .T.
...
If ! IsBlind() .Or. lForce   // lForce para automacao passar .T.
	...
	If ! lTabConc
		cMsg += "<b> </b><br>"	    //
		cMsg += "<b> " + STR0128 + " </b><br>"	    //"Não identificamos o uso do Conciliador Contábil."
		cMsg += "<b> </b><br>"
		cMsg += "<b> " + STR0129 + " </b><br>"		//"Ferramenta importante para Conciliação dos lançamentos."
		cMsg += "<b> " + STR0130 + " </b><br>"		//"Continua Apuração ?"
	...
	Else
		...
		If ! lSeekFil 
			cMsg += "<b> </b><br>"	    //
			cMsg += "<b> " + STR0131 + " </b><br>"	    //"Não identificamos o uso do Conciliador Contábil nesta filial."
			cMsg += "<b> </b><br>"
			cMsg += "<b> " + STR0129 + " </b><br>"		//"Ferramenta importante para Conciliação dos lançamentos."
			cMsg += "<b> " + STR0130 + " </b><br>"		//"Continua Apuração ?"
		Else
			If ! QLCFound(dDatApIni, dDatApFim)
				cMsg += "<b> </b><br>"	    //
				cMsg += "<b> " + STR0131 + " </b><br>"	    //"Não identificamos o uso do Conciliador Contábil nesta filial."
				cMsg += "<b> " + STR0132+DtoC(dDatApIni)+STR0133+DtoC(dDatApFim)+ " </b><br>"		//"No período de "##" a "
				cMsg += "<b>  </b><br>"			
				cMsg += "<b> " + STR0129 + " </b><br>"		//"Ferramenta importante para Conciliação dos lançamentos."
				cMsg += "<b> " + STR0130 + " </b><br>"	    //"Continua Apuração ?"
			EndIf
	...
	If !Empty(cMsg) .And. ! IsBlind()
		DEFINE DIALOG oDlg TITLE STR0134 FROM 080,080 TO 450,640 PIXEL //"Atenção"
