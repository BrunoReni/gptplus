...
Função para cadastro de usuário após a inclusãpo de cliente
@type 		Função
...
/*/
//-------------------------------------------------------------------
Static Function PnlCli(oPanel As Object, cCodSA1 As Character,cLojaSA1 As Character,cGrupSA1 As Charater)
...
Static Function PnlUsu(oPanel As Object, cCodSA1 As Character,cLojaSA1 As Character)
	...
	Local aUsers		As Array	
	Local nI			As Numeric
	Local nPosCodUsu	As Chararacter
