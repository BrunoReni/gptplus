...
Function FinaAtuFKX()
	...
	AAdd(aFKX,{cFilFKX,"10002",STR0013,"2","2","1","1","3","3","1",STR0013}) //"Rendimento decorrente do trabalho sem vínculo empregatício"
	...
	AAdd(aFKX,{cFilFKX,"11002",STR0025,"2","1","1","1","1","2","1",STR0025}) //"Decorrente de Decisão da Justiça Federal"
	...
	AAdd(aFKX,{cFilFKX,"11004",STR0028,"2","1","1","1","1","3","1",STR0029}) //"Responsabilidade Civil - juros e indenizações" ## "Responsabilidade Civil - juros e indenizações por lucros cessantes, inclusive astreinte"
	AAdd(aFKX,{cFilFKX,"11005",STR0030,"2","1","1","1","1","3","1",STR0031}) //"Decisão Judicial Importâncias pagas por danos morais" ## "Decisão Judicial Importâncias pagas a título de indenizações por danos morais, decorrentes de sentença judicial."
