...
Default bSemTela := {||.T.}
If !lAutomato
	MsgRun(STR0029,STR0028,{||  lRet := ( FWExecView( STR0033, "VIEWDEF." + cModOrc, nOperation, /*oDlg*/, {||.T.} /*bCloseOk*/, ;  // 'Orçamento Serviços' //"Montando os componentes visuais..." //"Aguarde" //'Orçamento de serviços'
