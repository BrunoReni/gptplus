...
IF !EMPTY(aGraf64)
	...
	QIEMGRAFIC(aGraf64[1],nChart/* aGraf64[2] */,aGraf64[3],aGraf64[4],aGraf64[5],,aGraf64[7],,.T.,.F.)
...
oPrint:Say(lin+150,1850,QK9->QK9_XBB,oFont08 )

oPrint:Line( lin+195,1700, lin+195, 1720 )   	// R medio
oPrint:Say(lin+200,1700,"R:",oFont08 )
oPrint:Say(lin+200,1850,QK9->QK9_RB,oFont08 )
...
oPrint:Say(lin+100,0040,STR0042+Space(5)+QK9->QK9_MEDLCI,oFont08 ) //"Limite de Controle Inferior(LCI):"
oPrint:Say(lin+100,0900,STR0043+Space(5)+QK9->QK9_MEDLCS,oFont08 ) //"Limite de Controle Superior(LCS):"
...
oPrint:Say(lin+260,0040,STR0042+Space(5)+QK9->QK9_AMPLCI,oFont08 ) //"Limite de Controle Inferior(LCI):"
oPrint:Say(lin+260,0900,STR0043+Space(5)+QK9->QK9_AMPLCS,oFont08 ) //"Limite de Controle Superior(LCS):"
...
oPrint:Say(lin+090,270,QK9->QK9_CAPDES,oFont08 )

oPrint:Say(lin+090,600,"Cp:",oFont08 )
oPrint:Say(lin+090,700,QK9->QK9_CP,oFont08 )

oPrint:Say(lin+170,160," CR:",oFont08 )
oPrint:Say(lin+170,270,QK9->QK9_CR,oFont08 )

oPrint:Say(lin+170,600,"Cpk:",oFont08 )
oPrint:Say(lin+170,700,QK9->QK9_CPK,oFont08 )

oPrint:Say(lin+090,1170,STR0048,oFont08 ) //"Desvio Padrao:"
oPrint:Say(lin+090,1400,QK9->QK9_PERDES,oFont08 )

oPrint:Say(lin+090,1730,"Pp:",oFont08 )
oPrint:Say(lin+090,1830,QK9->QK9_PP,oFont08 )

oPrint:Say(lin+170,1290," PR:",oFont08 )
oPrint:Say(lin+170,1400,QK9->QK9_PR,oFont08 )

oPrint:Say(lin+170,1730,"Ppk:",oFont08 )
oPrint:Say(lin+170,1830,QK9->QK9_PPK,oFont08 )
