...
WSSERVICE productionordersearch
    ...
    If (cAction = 'B' .Or. cAction = 'A') .Or. !fExitReg(cSearchId)  //Carrega tabela se for Busca ou não existir registro na tabela
        ...
        fCargaListOp(cAppointmentType, ::FilterSearch, cSearchId, cFormCode, cAction, ::productCode,::startDateRange,::endDateRange,::warehouseCode,::customerCode,::customerOrderCode,::activityCode,::machineCode,::workCenterCode,::isPlanned,::isOpened,::isStarted,::isIdle,::isPartiallyClosed,::isTotallyClosed,::isOpenedByMe,::isProductionRunning,::isStopRunning) // Insere tabela
    EndIf
...
@return Nil
/*/
Static Function fCargaListOp(cAppointmentType, cFilterSearch, cSearchId, cFormCode, cAction, cPrdCode, dStartRng,dEnDRng,cWhCode,cCustCode,cCustOrdCd,cOpCode,cMchCode,cWrkCntCd,lPlanned,lOpened,lStarted,lIdle,lPtClosed,lTtClosed,lOpndByMe,lPrdRung,lStpRng)
...
Static Function fRetOperOp(cAppointmentType, cOp, aRetOper, cStatusOp, lPOSFilOp, cFormCode, cOpCode, cMchCode, cWrkCntCd, cAction)
    ...
    If cAppointmentType == '3'
        ...
        If lShy
            ...
            cQuery    += "         (CASE WHEN SHY.HY_SITUAC = '2' THEN 1 ELSE 0 END) APONTAMENTO "  //Identifica se operação foi iniciada
