...
Function PCPLock(cRotina, lAguarda)
	...
	For nIndex := 1 To nTotal
		...
		If !LockByName(PREF_LOCK + aRotCheck[nIndex], .F. /*lEmpresa*/, .F. /*lFilial*/)
			If lAguarda
	...
	//Bloqueia a rotina
	If lReturn
		lReturn := LockByName(PREF_LOCK + cRotina, .F. /*lEmpresa*/, .F. /*lFilial*/)
	EndIf
...
Function PCPUnlock(cRotina)
	...
	UnLockByName(PREF_LOCK + AllTrim(cRotina), .F. /*lEmpresa*/, .F. /*lFilial*/)
