...
@since     24/03/2020
@version   12.1.30
@param 01 - cComponente, caracter, código do componente subproduto
@param 02 - cIDOpc     , caracter, código do IDOpcional do subproduto
@param 03 - nPeriodo   , número  , período da necessidade do subproduto
@param 04 - nQtd       , número  , quantidade da necessidade do subproduto
@return aItemEstru, array, array com os dados da estrutura referente Pai Válido do SubProduto
/*/
