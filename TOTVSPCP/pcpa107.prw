...
cMsgDesc := I18n(STR0215, {cLinkRot}) // "Deve ser realizada a migração do processo para a nova rotina: <b><a target='#1[link]#'>MRP Memória - PCPA712</a></b>."
PCPMsgExp("PCPA107", STR0214, "https://tdn.totvs.com/pages/viewpage.action?pageId=652585682", cLinkRot, Nil, 0, Nil, cMsgDesc) // "MRP Memória (PCPA712)"
